        ...
        <div class="col-md-2">
            <div class="booking-item-review-person">
                ...
                <p class="booking-item-review-person-name">
                    <?php printf( __( '%s', 'traveler' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
                </p>
        ...
        <div class="col-md-10">
            <div class="booking-item-review-content">
                ...
                <p class="booking-item-review-rate"><?php esc_html_e('Was this review helpful?','traveler')?>
                    ...
                    ?>
                    <b class="text-color"> <span class="number"><?php echo esc_html($count_like); ?></span> <?php echo __('like this', 'traveler'); ?></b>
