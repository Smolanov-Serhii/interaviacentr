    ...
    switch ($cs_style){
        case "st_tour_ver";
            ...
            <div class="cs-content">
                ...
                <h4 class="email"><i><?php echo sprintf(__('Please come back later or contact us, %s','traveler'),"<a href='mailto:".st()->get_option('email_admin_address' , "example@email.com")."'><span class='main-color'>".st()->get_option('email_admin_address' , "example@email.com")."</span></a>"); ?></i></h4>
                <!-- count down -->
                <?php
                ...
                <div class="progress progress-striped active">
                    <div class="progress-bar progress-bar-custom" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                        <span class="sr-only"><?php _e('100% Complete','traveler') ?></span>
                    </div>
                </div>
            </div>
            <?php
