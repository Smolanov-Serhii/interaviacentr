            ...
            <div class="package-cart mb20">
                ...
                <div class="cart-content">
                    ...
                    <div class="item">
                        ...
                        <span class="pull-right"><?php echo balanceTags($cls_package->convert_item($package->package_time, true)); ?></span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span class="pull-right"><?php echo balanceTags($cls_package->paser_list_services($package->package_services)); ?></span>
                    </div>
                </div>
