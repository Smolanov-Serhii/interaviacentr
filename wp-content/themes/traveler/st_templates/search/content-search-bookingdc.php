...
if ($bdc_status_iframe == 'on') {
    ...
    <form role="search" method="get" class="search main-search main-bookingdc-search" autocomplete="off"
        ...
        if ( $cname == '' || ( $cname != '' && $aid != $aid_default ) ) {
            ...
            echo '<input type="hidden" name="error_url" value="' . esc_url($domain . $target_page . '?aid=' . $aid) . ';" />';
        }
        elseif ( $cname != '' ) {
            ...
            echo '<input type="hidden" name="error_url" value="' . esc_url($domain . $target_page) . '" />';
        }
        else {
            echo '<input type="hidden" name="label" value="wp-searchbox-widget-' . esc_attr($aid) . '" />';
        }
        ...
        <button class="btn btn-primary btn-lg"
                type="submit"><?php echo __('Search for hotels', 'traveler'); ?></button>
    </form>
    <?php
}
?>
