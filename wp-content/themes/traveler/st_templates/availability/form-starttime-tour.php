        ...
        <div class="calendar-starttime-form">
            <div class="row">
                <div class="col-xs-6 ">
                    <div class="form-group">
                        <label for="calendar_starttime_check_in"><?php echo __('Check In', 'traveler'); ?></label>
                ...
                <div class="col-xs-6 ">
                    <div class="form-group">
                        <label for="calendar_starttime_check_out"><?php echo __('Check Out', 'traveler'); ?></label>
            ...
            <div class="form-group">
                ...
                <input type="submit" id="calendar_starttime_submit" class="btn btn-primary" name="calendar_starttime_submit"
                       value="<?php echo __('Update', 'traveler'); ?>">
