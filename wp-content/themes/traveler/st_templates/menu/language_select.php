    ...
    if(!empty($langs))
            {
                ...
                $current='
                    <a href="#" class="current_langs">
                        <img  height="12px" width= "18px" src="'.esc_url($value['country_flag_url']).'" alt="'.esc_attr($value['native_name']).'" title="'.esc_attr($value['native_name']).'">'.esc_html($value['native_name']).'<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
                    </a>';
                        break;
                    }
                }
