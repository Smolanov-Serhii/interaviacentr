                        ...
                        <?php if(has_nav_menu('primary')){
                            wp_nav_menu(
                                array(
                                    ...
                                    "container"=>"",
                                    'items_wrap'      => '<ul id="slimmenu" data-title="<a href=\''.esc_url(home_url('/')).'\'><img alt=\''.esc_attr(TravelHelper::get_alt_image()).'\' width=auto height=40px class=st_logo_mobile src='.esc_url($logo_url).' /></a>" class="%2$s slimmenu">%3$s</ul>',
