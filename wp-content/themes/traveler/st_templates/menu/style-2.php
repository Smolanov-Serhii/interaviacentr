                    ...
                    <div class="col-xs-12">
                        <div class="nav">
                            ...
                            if (!empty($logo_mobile_url)) {
                                $html_logo_mobile = '<a href=\'' . home_url('/') . '\'><img alt=\'' . esc_attr(TravelHelper::get_alt_image()) . '\' width=auto height=40px class=st_logo_mobile src=' . esc_url($logo_mobile_url) . ' /></a>';
                            }
