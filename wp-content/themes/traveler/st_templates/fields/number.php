...
<div class="form-group st-field-<?php echo esc_attr($data['type']); ?>">
    ...
    <input type="number" value="<?php echo esc_attr($value_std); ?>" id="<?php echo 'st-field-' . esc_attr($data['name']); ?>" name="<?php echo esc_attr($name_input); ?>" class="st-partner-field form-control" placeholder="<?php echo esc_html($plh); ?>" data-condition="<?php echo esc_attr($condition); ?>" data-operator="<?php echo esc_attr($operator); ?>"/>
