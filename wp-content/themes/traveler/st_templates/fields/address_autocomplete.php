...
$enable_mapbox = st()->get_option('st_mapboxx_enabled');
...
<div class="form-group st-field-<?php echo esc_attr($data['type']); ?>">
    ...
    <input type="text" id="<?php echo 'st-field-' . esc_attr($data['name']); ?>" name="<?php echo esc_attr($name_input); ?>" class="st-partner-field form-control" placeholder="<?php echo esc_html($plh); ?>" value="<?php echo esc_html($default); ?>" data-condition="<?php echo esc_attr($condition); ?>" data-operator="<?php echo esc_attr($operator); ?>" autocomplete="off"/>
