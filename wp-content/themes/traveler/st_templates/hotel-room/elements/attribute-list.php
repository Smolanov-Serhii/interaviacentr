...
<ul class="booking-item-features booking-item-features-sign clearfix">
    <?php if(!empty($adult_number)){?>
        <li title="" data-placement="top" rel="tooltip" data-original-title="<?php echo __('Adults Occupancy', 'traveler'); ?>"><i class="fa fa-male"></i>
            <span class="booking-item-feature-sign">x <?php echo esc_html($adult_number) ?></span>
        </li>
    <?php } ?>
    <?php if(!empty($children_number)){?>
        <li title="" data-placement="top" rel="tooltip" data-original-title="<?php echo __('Childs', 'traveler'); ?>"><i class="im im-children"></i>
            <span class="booking-item-feature-sign">x <?php echo esc_html($children_number) ?></span>
        </li>
    <?php } ?>
    <?php if(!empty($bed_number)){?>
        <li title="" data-placement="top" rel="tooltip" data-original-title="<?php echo __('Beds', 'traveler'); ?>"><i class="im im-bed"></i>
            <span class="booking-item-feature-sign">x <?php echo esc_html($bed_number) ?></span>
        </li>
    <?php } ?>
    <?php if(!empty($room_footage)){?>
        <li title="" data-placement="top" rel="tooltip" data-original-title="<?php echo __('Room footage (square meters)', 'traveler'); ?>"><i class="im im-width"></i>
            <span class="booking-item-feature-sign"><?php echo esc_html($room_footage) ?> <?php echo esc_html('m', 'traveler'); ?></span>
        </li>
    <?php } ?>
