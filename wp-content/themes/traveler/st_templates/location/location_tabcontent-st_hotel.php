...
if(have_posts()) {
    ...
    echo '<div class="col-xs-12"><div class="alert alert-warning">' . __( "There are no available hotel for this location, time and/or date you selected." , 'traveler' ) . '</div></div>';
}
if($st_location_style == "list") {
    $return .= '</ul>';
} else {
