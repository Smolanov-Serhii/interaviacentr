		...
		<a class="hover-img" href="<?php echo esc_url($link) ; ?>">
			...
			<div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
				<div class="text-small">
					...
					<p><?php echo ($reviews>=1)? esc_attr($reviews)." ".__('reviews','traveler') : __("0 review",'traveler')  ;?></p>
					<p class="mb0"><?php echo ($offers >=1) ? esc_attr($offers)." ".__('offers','traveler') : __("0 offer",'traveler') ;   echo ' '.__('from','traveler'); echo TravelHelper::format_money( $min_max_price['price_min'] ) ?></p>
				</div>
			</div>
		</a>
	</div>
