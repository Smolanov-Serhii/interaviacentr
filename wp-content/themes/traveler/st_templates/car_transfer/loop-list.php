...
<li <?php post_class( 'booking-item st_lazy_load' ) ?>>
    ...
    <div class="row">
        ...
        <form action="" method="post" class="form-booking-car-transfer">
                    ...
                    <?php
                        ...
                        if ( $passenger > 0 ):
                            ...
                            <li title="" data-placement="top" rel="tooltip"
                                data-original-title="<?php echo esc_html($passenger) . ' ' . __( 'Passengers', 'traveler' ) ?>">
                            ...
                            <li title="" data-placement="top" rel="tooltip"
                                data-original-title="<?php
                                    echo esc_attr( $time[ 'distance' ] ) . ' ' . __( 'Km', 'traveler' );
                                ?>">
            ...
            <div class="col-md-3">
                <p class="booking-item-price-from"><?php _e( "Price from", 'traveler' ) ?></p>
                <?php
                ...
                <input type="hidden" name="car_id" value="<?php echo get_the_ID(); ?>">
                    ...
                    if($external_book == 'on'){
                        ...
                        ?>
                            <a href="<?php echo esc_url($external_link); ?>" class="btn btn-primary"><?php echo __('Book Now', 'traveler'); ?></a>
                        <?php
                    }else{
                        ?>
