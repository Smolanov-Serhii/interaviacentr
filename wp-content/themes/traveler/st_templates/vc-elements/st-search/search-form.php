                ...
                foreach($list_tab as $k => $value){
                    ...
                    if($value['check_tab'] != 'off') {
                        ...
                        <li <?php if($i == 0) echo 'class="active"'; ?>>
                            <a href="#tab-<?php echo sanitize_title( $value[ 'tab_name' ] ).esc_attr($k) ; ?>"
                ...
                if(!empty($list_tab)):
                    ...
                    foreach( $list_tab  as $k => $v){
                        ...
                        if($v['check_tab'] != 'off'){
                            switch($v['tab_name']){
                                case "hotel":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-hotel'.esc_attr($k).'">';
                                    ...
                                    break;
                                case "cars":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-cars'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case "rental":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-rental'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case "tour":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-tour'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case "activities":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-activities'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case "all_post_type":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-all_post_type'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case "hotel_room":
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-hotel_room'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                ...
                                case "custom_flight":
                                    ...
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-custom_flight'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case 'tp_flight':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-tp_flight'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case 'tp_hotel':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-tp_hotel'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case 'ss_flight':
                                    $html .= '<div class="tab-pane fade '.esc_attr($active).'" id="tab-ss_flight'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                ...
                                case 'flight':
                                    ...
                                    break;
                                case 'car_transfer':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-car_transfer'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                ...
                                case 'hotels_combined':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-hotels_combined'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case 'bookingdc':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-bookingdc'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
                                    ...
                                    break;
                                case 'expedia':
                                    $html .='<div class="tab-pane fade '.esc_attr($active).'" id="tab-expedia'.esc_attr($k).'">';
                                    if (empty($v['tab_html_custom'])){
