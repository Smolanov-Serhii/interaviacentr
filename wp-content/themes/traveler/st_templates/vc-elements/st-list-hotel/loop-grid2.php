                ...
                <p class="mb0 text-darken">
                   <?php
                        ...
                        if(STHotel::is_show_min_price()){
							printf(__('from %s /night','traveler'),'<span class="text-lg lh1em text-color">'.TravelHelper::format_money($price).'</span><small> ');
							echo '</small>';
						}else{
							printf(__('%s avg/night','traveler'),'<span class="text-lg lh1em text-color">'.TravelHelper::format_money($price).'<small> ');
							echo '</small>';
                        }
                        ?>
				</p>
