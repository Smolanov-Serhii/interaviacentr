                ...
                <a class="hover-img" href="<?php the_permalink()?>">
                    ...
                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
                        <div class="text-small">
                            <h5><?php the_title()?></h5>
                            <p><?php comments_number(__('no review','traveler'),__('1 review','traveler'),__('% reviews','traveler'))  ?></p>
                            <?php
                            $count_offer=100;
                            ...
                            ?>
                                <p class="mb0"><?php
                                    if($count_offer==1){
                                        printf(__('%s offer','traveler'),$count_offer);
                                    }else{
                                        printf(__('%s offers','traveler'),$count_offer);
                                    }

                                    $price = STHotel::get_price();
                                    if(STHotel::is_show_min_price()){
                                        printf(__(' price from %s','traveler'),TravelHelper::format_money($price));
                                    }else{
                                        printf(__(' price avg %s','traveler'),TravelHelper::format_money($price));
                                    }
