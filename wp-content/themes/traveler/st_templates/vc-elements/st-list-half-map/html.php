<?php
    ...
    if($check_enable_map_google !== 'on'){ 
        ...
        echo st()->load_template( 'vc-elements/st-list-half-map/html-mapbox',false, $data_array);
        return;
    }
    wp_enqueue_script( 'gmap-init-list-map' );
    //wp_enqueue_script( 'detailed-map' );
?>
<span class="hidden st_list_half_map_before"
    data-map_height = '<?php
    if (!empty($auto_height) and $auto_height =='fixed') {
        echo esc_attr($height);
    }
    else {
        echo "map_full_height";
    }
    ?>'
></span>
<div class='row half_map_container'>
            ...
            <div id="gmap_wrapper" class="st_list_half_map row" >
                ...
                <div class="gmap-controls">
                    <div id="gmap-control">
                        ...
                        <span class="st_my_location_list_half_map" style="display: block;"><i class="fa fa-map-marker"></i><?php _e( "My Location" , 'traveler' ) ?></span>
                        <span class="st-gmap-full-half" data-full='<i class="fa fa-arrows-alt"></i><?php _e( "Fullscreen" , 'traveler' ) ?>' data-no-full='<i class="fa fa-square-o"></i><?php _e( "Default" , 'traveler' ) ?>'>
    ...
    <div class="col-md-6 div_half_map">
        ...
        <div class="row data_list_hafl_map">
            <div class='col-md-12'><h3 class='mb30 mt30'><?php printf(__("Advanced Search  <span class='count_advan_saerch'>(%s)</span>",'traveler'),count($data_map)) ?></h3></div>
...
?>
<span class="hidden st_list_half_map_data"
    data-auto_height   = '<?php echo str_ireplace(array("'"),'\"',$auto_height); ?>';
    data-height = '<?php echo str_ireplace(array("'"),'\"',$height); ?>';
    data-data_map = '<?php echo str_ireplace(array("'"),'\"',$data_map); ?>';
