...
<form id="hotel_search_half_map" method="get" class="search main-search filter_search_map" action="<?php echo home_url() ?>">
    ...
    <?php if(!empty($form_search_advance)):?>
        ...
        <!--End search Advance-->
    <?php endif;?>
    <button class="btn btn-primary btn_search btn-lg" data-title="<?php esc_html_e('Search for Rental','traveler') ?>" type="submit"><?php esc_html_e('Search for Rental','traveler') ?></button>
    <hr>
</form>
