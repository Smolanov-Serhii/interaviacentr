...
<div class='row half_map_container'>
    <?php if($map_position == 'left'): ?>
        <div class="col-md-6 st_gmap">
            <div id="st_list_half_map" class="st_list_half_map row" >
                <div class="content_map"  >
                    <div id="list_half_mapbox" class="gmap3" data-fitbounds="<?php echo esc_html($fit_bounds)?>" style=" width: 100%; height:100%;"></div>
                </div>
...
?>
<span class="hidden st_list_half_mapbox_data"
