    ...
    <div class="thumb item_map">
        ...
        <div class="thumb-caption">
            ...
            <p class="mb0 text-darken">
                <a class="text-darken" href="<?php echo esc_url($link)?>"><?php _e('in ', 'traveler') ?><?php  echo get_the_title($hotel_id)?></a>
            </p>
            ...
            <?php if(get_post_type($hotel_id) == 'st_hotel'): ?>
                ...
                <?php if (STHotel::is_show_min_price()) { ?>
                    <span class="text-lg lh1em"><?php echo TravelHelper::format_money(STHotel::get_price($hotel_id)) ?></span>
                    <small> <?php esc_html_e('/night','traveler')?></small>
                <?php } else { ?>
                    <span class="text-lg lh1em"><?php echo TravelHelper::format_money(STHotel::get_price($hotel_id)) ?></span>
            ...
            <?php if(get_post_type($hotel_id) == 'st_rental'): ?>
                ...
                if(!empty($features)):?>
                    ...
                    foreach($features as $key=>$value):
                        ...
                        echo '<li rel="tooltip" data-placement="top" title="" data-original-title="'.esc_html($value['title']).'"><i class="'.TravelHelper::handle_icon($value['icon']).'"></i>';
                        if($value['number']){
            ...
            <?php endif; ?>
            <a class="btn btn-primary btn_book" href="<?php echo esc_url($link)?>"><?php _e("Book Now",'traveler') ?></a>
