<div class="room-facility about_listing">
	<h3 class="booking-item-title"><?php echo __('About This Listing', 'traveler'); ?></h3>
	<?php 
	...
	<div class="row list-facility">
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-5 col-sm-3">
					<strong><?php echo __('Check in/out time', 'traveler'); ?></strong>
				</div>
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Check In time', 'traveler') ?>: <strong><?php if($check_in_time) echo esc_html($check_in_time); ?></strong></span>
						</div>
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Check Out time', 'traveler') ?>: <strong><?php if($check_out_time) echo esc_html($check_out_time); ?></strong></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-5 col-sm-3">
					<strong><?php echo __('The Space', 'traveler'); ?></strong>
				</div>
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Adult number', 'traveler') ?>: <strong><?php echo esc_html($adult_number); ?></strong></span>
						</div>
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Bed number', 'traveler') ?>: <strong><?php echo esc_html($bed_number); ?></strong></span>
						</div> 
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Children number', 'traveler') ?>: <strong><?php echo esc_html($children_number); ?></strong></span>
						</div>
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Room Footage', 'traveler') ?>: <strong><?php echo esc_html($room_footage); ?></strong></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-5 col-sm-3">
					<strong><?php echo __('Prices', 'traveler'); ?></strong>
				</div>
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Price', 'traveler') ?>: <strong><?php echo TravelHelper::format_money($html_price)?></strong></span>
						</div>
						<?php  if(!empty($sale_price_from)): ?>
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Sale price from', 'traveler') ?>: <strong><?php echo date_i18n(TravelHelper::getDateFormat(),strtotime($sale_price_from)); ?></strong></span>
						</div>
						<?php endif; ?>
						<?php if(!empty($sale_price_to)): ?>
						<div class="col-xs-12 col-sm-6 sub-item">
							<span><?php echo __('Sale price to', 'traveler') ?>: <strong><?php  echo date_i18n(TravelHelper::getDateFormat(),strtotime($sale_price_to)); ?></strong></span>
						</div>
						<?php endif; ?>
                        <?php
						...
						<div class="col-xs-12 col-sm-6 sub-item">
							...
							<span><?php echo __('Discount', 'traveler') ?>: <strong><?php echo esc_html($discount); ?> </strong> %</span>
                            <?php endif; ?>
							<?php if( !empty( $deposit ) ): ?>
							<div class="clearfix">
								<p>
									<span><?php echo __('Deposit', 'traveler') ?>: <strong><?php echo esc_html($deposit); ?></strong></span>
								</p>
							</div>
							<?php endif; ?>
						</div>
		...
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-12 col-sm-3">
					<strong><?php echo __('Discount by day', 'traveler') ?></strong>
				</div>
				<div class="col-xs-12 col-sm-9">
					<table class="table">
						<tr>
							...
							<th><?php echo __('Discount','traveler'); ?> <?php if( $discount_type ) echo '( '. esc_attr($discount_type) . ' )'; ?></th>
						</tr>
		...
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-5 col-sm-3">
					<strong><?php echo __('Other', 'traveler'); ?></strong>
				</div>
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						<?php 
        ...
        if($cancel_policy == 'on'):
            ...
            <div class="col-xs-12 item">
                <div class="row">
                    <div class="col-xs-5 col-sm-3">
                        <strong><?php echo __('Cancellation', 'traveler'); ?></strong>
                    </div>
                    <div class="col-xs-7 col-sm-9">
                        <p><?php
                            ...
                            echo sprintf(__('Cancellation within %s Day(s) before the date of arrival %s%s will be charged.', 'traveler'), $cancel_policy_day, $cancel_policy_amount, '%');
                            ?></p>
                    </div>
                </div>
            </div>
		...
		<div class="col-xs-12 item">
			<div class="row">
				<div class="col-xs-5 col-sm-3">
					<strong><?php echo __('Description', 'traveler'); ?></strong>
				</div>
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						<div class="col-xs-12 sub-item">
							<div class="text-justify">
								...
								<a class="button-readmore text-color" href="javascript:;"><?php echo __('Read more', 'traveler'); ?></a>
