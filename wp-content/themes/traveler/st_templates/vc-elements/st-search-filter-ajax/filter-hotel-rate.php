...
for( $i = $max_rate ; $i >= 1 ; $i-- ) {
    ...
    ?>
    <div class="checkbox-filter-ajax" data-type="hotel-rate" data-value ="<?php echo esc_attr( $i )?>" ><span class="checkbox-yes"><i class="fa fa-check" aria-hidden="true"></i></span></div>
