            ...
            <div class="col-md-12">
                ...
                <ul class="booking-item-features booking-item-features-sign clearfix mt10">
                    ...
                    <?php if($room_footage=get_post_meta(get_the_ID(),'room_footage',true)): ?>
                        ...
                        <li rel="tooltip" data-placement="top" title="" data-original-title="<?php esc_html_e('Room footage (square meters)','traveler')?>"><i class="im im-width"></i><span class="booking-item-feature-sign"><?php echo esc_html($room_footage) ?></span>
                        </li>
                    <?php endif;?>
                </ul>
            </div>
