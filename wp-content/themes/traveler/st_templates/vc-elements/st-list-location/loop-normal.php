                            ...
                            if(!wp_is_mobile()) {
	                            ...
	                            <?php if ( ! empty( $offer ) ) { ?>
                                    <p class="mb0">
			                            <?php
			                            if ( $offer > 1 ) {
				                            printf( __( '%d offers from %s', 'traveler' ), $offer, TravelHelper::format_money( $min_price ) );
			                            } else {
				                            printf( __( '%d offer from %s', 'traveler' ), $offer, TravelHelper::format_money( $min_price ) );
			                            }
			                            ?>
                                    </p>
		                            <?php
