    ...
    <div class="row">
        ...
        if(!empty($fields))
        {
            foreach($fields as $key=>$value)
            {
                ...
                ?>">
                    <?php echo st()->load_template('rental/elements/search/field_'.esc_html($name),false,array('data'=>$value,'location_name'=>'location_name')) ?>
                </div>
            <?php
            }
        }?>
    ...
    <?php if(st()->get_option('allow_rental_advance_search')=='on'):?>
        ...
        <div class="search_advance">
            <div class="expand_search_box form-group-<?php echo esc_attr($field_size);?>">
                <span class="expand_search_box-more"> <i class="btn btn-primary fa fa-plus mr10"></i><?php echo esc_html__("Advanced Search",'traveler') ; ?></span>
                <span class="expand_search_box-less"> <i class="btn btn-primary fa fa-minus mr10"></i><?php echo esc_html__("Advanced Search",'traveler') ; ?></span>
            </div>
