...
<tr>
    ...
    <td valign="top">
        ...
        <?php 
            ...
            if( $address ):
        ?>
        <p><strong><?php _e('Address', 'traveler'); ?></strong> <i class="fa fa-map-marker mr5"></i><?php echo esc_html( $address ); ?></p>
        <?php endif; ?>
		...
		<?php if($adult_number){?>
        <p><strong><?php echo __('Number of Adult: ', 'traveler'); ?></strong> <?php echo esc_html($adult_number); ?></p>
		<?php } ?>
		<?php if($child_number){?>
        <p><strong><?php echo __('Number of Children: ', 'traveler'); ?></strong> <?php echo esc_html($child_number); ?></p>
		<?php } ?>
        <?php 
