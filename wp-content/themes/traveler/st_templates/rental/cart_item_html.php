...
if(isset($item_id) and $item_id):
    ...
    <ul class="booking-item-payment-details">
        <li>
            <h5><?php echo __('Rental', 'traveler'); ?></h5>
            ...
            <ul class="booking-item-payment-price">
                ...
                <li>
                    <p class="booking-item-payment-price-title">
                        <?php echo __('Number Night', 'traveler'); ?>
                    </p>
                    <p class="booking-item-payment-price-amount">
                        <?php
                        if($numberday > 1){
                ...
                <?php if($adult_number){?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount"><?php echo esc_html($adult_number).__(' Adult(s)', 'traveler');?></p>
                    </li>
                <?php }?>
                <?php if($child_number){?>
                    <li>
                        <p class="booking-item-payment-price-title"><?php _e("Number of Children",'traveler') ?></p>
                        <p class="booking-item-payment-price-amount"><?php echo esc_html($child_number).__(' Children', 'traveler');?></p>
                    </li>
                <?php }?>
