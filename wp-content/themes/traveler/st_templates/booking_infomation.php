...
<h5 class="text-center mb30"><?php _e('Booking details has been sent to: ','traveler');
    echo get_post_meta($order_code, 'st_email', true) ?> </h5>

<p><strong><?php echo __('Booking Number :' , 'traveler' ) ;  ?></strong> <?php echo esc_html($order_code) ?></p>

<p>
<strong><?php echo __('Booking Date :' , 'traveler' ) ;  ?></strong> <?php echo get_the_time(TravelHelper::getDateFormat(), $order_code) ?>
</p>

<p><strong><?php echo __('Payment Method :' , 'traveler' ) ;  ?></strong> <?php
        ...
        <table cellspacing="0px" cellpadding="0" width="100%" class="tb_cart_total">
            ...
            <tr>
                <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Adult Price' , 'traveler') ;  ?></strong></td>
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Children Price' , 'traveler') ;  ?></strong></td>
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Infant Price' , 'traveler') ;  ?></strong></td>
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php
                if($key == 'car_transfer'){
                    ...
                    <tr>
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <strong><?php echo __('Car price' , 'traveler') ;  ?></strong></td>
                        <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                    ...
                    <tr>
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <strong><?php echo __('Extra price' , 'traveler') ;  ?></strong></td>
                        <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                    ...
                    <?php if(!empty($discount_rate)) { ?>
                        <tr>
                            <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                                <strong><?php echo __('Discount rate', 'traveler'); ?></strong></td>
                            <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Subtotal' , 'traveler') ;  ?></strong></td>
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php endif; ?>
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Hotel Package Price' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php endif; ?>
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Activity Package Price' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php endif; ?>
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Car Package Price' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php endif; ?>
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Flight Package Price' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Equipment Price' , 'traveler') ;  ?></strong></td>
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Tax' , 'traveler') ;  ?></strong></td>
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <tr>
                <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                    <strong><?php echo __('Coupon' , 'traveler') ;  ?></strong></td>
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">-
            ...
            <?php if(is_array($deposit_status) && !empty($deposit_status['type']) && floatval($deposit_status['amount']) > 0): ?>
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Deposit' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                ...
                if(!empty($booking_fee_price = get_post_meta($order_code, 'booking_fee_price', true))){
                    ...
                    <tr>
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <strong><?php echo __('Fee' , 'traveler') ;  ?></strong></td>
                        <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Total' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Pay Amount' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
            ...
            <?php endif;
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Passenger' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Tax Depart' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
                ...
                <tr>
                    <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        <strong><?php echo __('Tax Return' , 'traveler') ;  ?></strong></td>
                    <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px; font-weight: bold;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('Address Line 1' , 'traveler') ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('Address Line 2' , 'traveler' ) ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('City' , 'traveler') ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('State/Province/Region' , 'traveler') ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('ZIP code/Postal code' , 'traveler') ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('Country' , 'traveler') ;  ?></strong></td>
    <td align="right" class="text-right" style="border-bottom: 1px dashed #ccc;padding:10px;">
...
<tr>
    <td width="50%" style="border-bottom: 1px dashed #ccc;padding:10px;">
        <strong><?php echo __('Special Requirements' , 'traveler') ;  ?></strong></td>
