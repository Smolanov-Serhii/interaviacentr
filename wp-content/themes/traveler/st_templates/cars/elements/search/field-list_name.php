...
$list_name = TravelHelper::get_list_name('st_cars'  , $max_num);
    if($is_required == 'on'){
...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <label for="field-car-list-name"><?php echo esc_html( $title)?></label>
    <i class="fa  fa-sort input-icon"></i>
   <select id="field-car-list-name" name="item_id" class="form-control <?php echo esc_attr($is_required) ?>" >
