...
$activity_external = get_post_meta($post_id, 'st_activity_external_booking', true);
$activity_external_link = get_post_meta(get_the_ID(), 'st_activity_external_booking_link', true);
?>
<?php if($activity_external == 'off' || empty($activity_external)){ ?>
            ...
            <div class="section">
                <div class="package-book-now-button">
                    ...
                    if (!get_option('permalink_structure')) {
                        echo '<input type="hidden" name="st_activity"  value="' . esc_attr($activity_obj->post_name) . '">';
                    }
                    ?>
                    ...
                    <div class="div_book">
                        <div class="booking-meta">
                            <div class="meta-item">
                                <div class="meta-title"><i class="fa fa-calendar"></i> <?php echo __('Activity date', 'traveler') ?></div>
                                <div class="meta-value select-date">
                                    <a  href="#list_activity_item" id="select-a-activity" class="btn btn-primary btn-sm btn-select-date"><?php echo __('Select date', 'traveler'); ?></a>
                                ...
                                if ( $activity_external_booking == "on" and $activity_external_booking_link !== "" ) {
                                    if ( get_post_meta( $post_id, 'st_activity_external_booking_link', true ) ) {
                                        ...
                                        <a class='btn btn-primary'
                                            href='<?php echo esc_url(get_post_meta( $post_id, 'st_activity_external_booking_link', true )); ?>'> <?php st_the_language( 'book_now' ) ?></a>
                                        <?php
                                        $return = ob_get_clean();
                                    }
                                } else {
