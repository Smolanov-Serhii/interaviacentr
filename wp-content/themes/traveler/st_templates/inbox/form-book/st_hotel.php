...
?>
<?php if($st_room_external_booking == 'off' || empty($st_room_external_booking)){ ?>
                ...
                <div class="package-book-now-button">
                    ...
                    <div class="div_book" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>">
                        <div class="booking-meta">
                            ...
                            <div class="meta-item">
                                <div class="meta-title"><?php echo __('Room(s)', 'traveler') ?></div>
                                <div class="meta-value">
                            ...
                            <div class="guest_name_input hidden mb15" data-placeholder="<?php esc_html_e('Guest %d name','traveler') ?>" data-hide-children="<?php echo get_post_meta($room_id,'disable_children_name',true) ?>" data-hide-infant="<?php echo get_post_meta($room_id,'disable_infant_name',true) ?>">
...
<?php } else { ?>
    <form id="form-booking-inpage" method="post" action="" class="single-room-form form-has-guest-name">
        <div class="st-inbox-form-book">
            <?php if(!empty($bg_thumb)){ ?>
            ...
            <?php } ?>
            <h3><a href="<?php echo get_the_permalink($post_id); ?>"><?php echo get_the_title($room_id); ?></a></h3>
            <div class="section">
                <div class="package-book-now-button">
                    <div class="div_book">
                        <div class="div_btn_book_tour booking-meta">
                            <a href="<?php echo esc_url($external); ?>"
