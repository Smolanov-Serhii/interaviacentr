    ...
    <div class="st-gallery-map st-gallery-half-map st-full-height">
        ...
        <div class="st-tour-map">
            ...
            if(!empty($location_center)){
                ?>
                <div id="st-hotelhalf-mapbox-new" data-style="<?php echo esc_attr($map_style); ?>" data-autoload_map="1" data-marker-icon='<?php echo esc_url($marker_icon); ?>' data-location='<?php echo json_encode($location_center)?>'>
