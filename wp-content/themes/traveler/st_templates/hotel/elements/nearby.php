                ...
                <div class="hotel-item-1">
                    ...
                    <div class="caption-content ">
                        ...
                        <p class="description">
                            ...
                            if(!empty($address)) {
                                echo '<p class="address"><i class="fa fa-map-marker"></i> ' . esc_html($address) . '</p>';
                            }
                            ?>
                        </p>
                        <p class=""></p>
                        ...
                        if($count_review > 0){
                            ...
                            <div class="review">
                                ...
                                <span class="count">
                                <?php echo sprintf(_n(esc_html__('%d review', 'traveler'),esc_html__('%d reviews', 'traveler'),$count_review), $count_review); ?>
                            </span>
                            </div>
                        <?php } ?>
                        <span class="price">
                        ...
                        <a class="btn btn-primary btn-normal book-now" href="<?php echo get_the_permalink(); ?>"><?php echo esc_html__('Book Now', 'traveler'); ?></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            ...
                            <?php else:
                                $price = HotelHelper::get_avg_price_hotel(get_the_ID());
                                ?>
                                <span class="booking-item-price-from"><?php _e("avg", 'traveler') ?></span>
                            <?php endif;?>
                            <span
                                class="booking-item-price"><?php echo TravelHelper::format_money($price) ?></span><span>/<?php echo __('night', 'traveler'); ?></span>
