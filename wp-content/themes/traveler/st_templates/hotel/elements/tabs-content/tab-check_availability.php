            ...
            <?php if(!empty($phone)){ ?>
                <div class="col-md-6">
                    <div class="contact">
                        ...
                        <div class="caption">
                            <p class="title"><?php esc_html_e("Phone",'traveler') ?></p>
            ...
            <?php if(!empty($fax)){ ?>
                <div class="col-md-6">
                    <div class="contact">
                        ...
                        <div class="caption">
                            <p class="title"><?php esc_html_e("Fax",'traveler') ?></p>
            ...
            <?php if(!empty($email)){ ?>
                <div class="col-md-6">
                    <div class="contact">
                        ...
                        <div class="caption">
                            <p class="title"><?php esc_html_e("Email support",'traveler') ?></p>
            ...
            <?php if(!empty($website)){ ?>
                <div class="col-md-12">
                    <div class="contact">
                        ...
                        <div class="caption">
                            <p class="title"><?php esc_html_e("Hotel Website",'traveler') ?></p>
...
<div class="row">
    <div class="col-md-12">
        <h3 class="avalable-title"><?php esc_html_e("AVAILABLE ROOMS",'traveler') ?></h3>
