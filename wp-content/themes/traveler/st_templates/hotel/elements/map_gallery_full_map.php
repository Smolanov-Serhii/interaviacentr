...
if($google_api_key === 'on'){
    ...
    echo st()->load_template('hotel/elements/map_gallery_full_mapbox', '');
    return;
}
    ...
    <div class="review-price">
        ...
        <span class="price">
            ...
            if (STHotel::is_show_min_price()) {
                echo esc_html__('Price from ', 'traveler');
            }else{
    ...
    <div class="st-tour-map st-hide">
        ...
        <div class="view-control">
            <div class="oceaus-relative">
                <a class="full-screen" data-class="full-screen" href="#"><?php echo esc_html__('FULL SCREEN', 'traveler')?></a>
                <a class="exit-full-screen" data-class="exit-full-screen" href="#"><?php echo esc_html__('DEFAULT','traveler')?></a>
                <a class="view" data-class="view" href="#"><?php echo esc_html__('VIEW','traveler'); ?></a>
                <div class="map_type">
                    <span class="st-map-type1 st-type-1" data-map="style_normal"><?php echo esc_html__('Normal','traveler')?></span>
                    <span class="st-map-type1 st-type-2" data-map="style_midnight"><?php echo esc_html__('Midnight','traveler')?></span>
                    <span class="st-map-type1 st-type-3" data-map="style_icy_blue"><?php echo esc_html__('Icy Blue','traveler')?></span>
                    <span class="st-map-type1 st-type-4" data-map="style_family_fest"><?php echo esc_html__('Family Fest','traveler')?></span>
                    <span class="st-map-type1 st-type-5" data-map="style_open_dark"><?php echo esc_html__('Open Dark','traveler')?></span>
                    <span class="st-map-type1 st-type-6" data-map="style_riverside"><?php echo esc_html__('Riverside','traveler')?></span>
                    <span class="st-map-type1 st-type-7" data-map="style_ozan"><?php echo esc_html__('Ozan','traveler')?></span>
                </div>
            </div>
        </div>
