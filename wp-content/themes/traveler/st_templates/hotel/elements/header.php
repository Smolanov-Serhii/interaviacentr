...
?>
<header class="">
    <h1 class="lh1em featured_single" itemprop="name"><?php the_title()?>
	...
	<ul class="list list-inline text-small">
		...
		<?php if($phone=get_post_meta(get_the_ID(),'phone',true)):?>
			<li itemprop="telephone"><a href="tel:<?php echo str_replace(' ','',trim($phone)); ?>"> <i class="fa fa-phone"></i> <?php echo esc_html( $phone);?></a>
			</li>
		<?php endif;?>
