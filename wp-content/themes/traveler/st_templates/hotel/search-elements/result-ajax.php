                ...
                <?php
                        ...
                        if(!empty($st_orderby)) {
                            ...
                            if (!in_array($active, $orderby_key)) {
                                echo '<li class="active" style="display: none !important;"><a class="checkbox-filter-ajax" data-type="order" data-value="' . esc_html($active) . '"></a>';
                            }
                        }else{
                            echo '<input type="hidden" id="jhotel-orderby" value="-1" />';
                            $active = STInput::request('orderby');
                        }
                        echo '<input type="hidden" id="jhotel-category" value="'. esc_html($taxonomy) .'" />';
