            ...
            <ul class="booking-item-payment-price">
                <li>
                    ...
                    <p class="booking-item-payment-price-amount">
                        ...
                        <br />
                        <button id="getInfoPriceLink" type="button" class="btn btn-primary btn-xs pull-right" style="margin-bottom: 1px;" aria-expanded="false" aria-controls="getInfoPrice" data-toggle="collapse" data-target="#getInfoPrice"><?php echo __('Details', 'traveler'); ?></button>
                    </p>
                ...
                <li>
                    <p class="booking-item-payment-price-title">
                        <?php echo __('Number of Night', 'traveler'); ?>
                    </p>
                    <p class="booking-item-payment-price-amount">
                        <?php
                        if($date_diff>1){
                ...
                <li>
                    <p class="booking-item-payment-price-title"><?php _e("Number of Room",'traveler') ?></p>
                    <p class="booking-item-payment-price-amount"><?php echo esc_html($item['number']).__(' Room(s)', 'traveler');?></p>
                </li>
                <?php if($adult_number) {?>
                    <li>
                ...
                <?php if(isset($extras['value']) && is_array($extras['value']) && count($extras['value'])): ?>
                    <li>
                        ...
                        <p class="booking-item-payment-price-amount">
                            ...
                            <?php echo esc_html($extras['title'][$name]).' ('.TravelHelper::format_money($price_item).') x '.$number_item.' '.__('Item(s)', 'traveler'); ?>
                        </span> <br />
                ...
                if(isset($item['data']['deposit_money'])):
                    ...
                    ?>
                    <li>
                        <p class="booking-item-payment-price-title"><?php printf(__('Deposit %s','traveler'),$deposit['type']) ?> </p>
