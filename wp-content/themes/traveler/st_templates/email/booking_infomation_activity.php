...
if($type_activity == 'specific_date')
    $title_type_activity = __('Specific Date','traveler');
if($type_activity == 'daily_activity')
    $title_type_activity = __('Daily Activity','traveler');
                ...
                $i = 0;
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                            ...
                            <p><strong><?php echo __('Activity :' , 'traveler'); ?> :</strong> <a target="_blank" href="<?php  echo get_the_permalink($object_id)?>"><?php  echo get_the_title($object_id)?></a> </p>
                            ...
                            <p>
                                <strong><?php _e( "Activity Type:" , 'traveler' ) ?></strong> 
