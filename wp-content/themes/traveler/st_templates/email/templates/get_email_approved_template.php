...
<div style="background: #dfdfdf; padding: 30px 50px;"><table id="booking-infomation" class="wrapper" style="width: 1000px; font-family: Poppins, sans-serif !important;" width="90%" cellspacing="0" align="center">
    ...
    <table id="" class="wrapper" style="padding: 50px 25px; width: 1000px; color: #666;font-family: Poppins, sans-serif !important; background: #fff" width="90%;" cellspacing="0" align="center">    <tbody>
    <tr id="title">
        <td style="padding: 10px; border-top: 1px solid #CCC;">
            ...
            <p>&nbsp;</p>
            <p style="text-align: center;"><a class="btn btn-primary" style="text-decoration: none; color: white; background: #5192FA; font-size: 20px; padding: 10px 20px 10px 20px;" href="[st_approved_email_item_link]" target="_blank">Check</a></p>
