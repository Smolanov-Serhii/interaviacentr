...
<div style="background: #dfdfdf; padding: 30px 50px;"><table id="booking-infomation" class="wrapper" style="width: 1000px; font-family: Poppins, sans-serif !important;" width="90%" cellspacing="0" align="center">
    ...
    <tr>
        <td style="padding-bottom: 20px; font-size: 20px;">
            <strong style="font-size: 30px;">Hello [st_email_booking_first_name] [st_email_booking_last_name]</strong>,
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tbody>
    <tr>
        <td style="padding-bottom: 20px; font-size: 20px; text-align: center">
            <strong style="font-size: 25px;">Cancellation/ Amendment policy</strong>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding-bottom: 20px; text-align: center">
            <a href="[st_email_booking_url_booking_history]" target="_blank" style="background-color: #5192FA;border-radius: 5px;color: #fff;font-family: tahoma;font-size: 14px;font-weight: 700;margin-left: 10px;padding: 10px 30px;text-decoration: none;">
                BOOKING HISTORY
            </a>
        </td>
    </tr>
