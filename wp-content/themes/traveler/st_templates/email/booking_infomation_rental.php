    ...
    <tr style="background: white">
        <td colspan="10" style="padding: 10px;">
            ...
            <?php 
                if($made_by_admin):
            ?>
            <?php printf(__('As you required us to booking "%s".', 'traveler'), get_the_title($rental_id)); ?>
             <br />
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                            ...
                            <p><strong><?php echo __('Rental' , 'traveler') ;  ?> :</strong> <a target="_blank" href="<?php  echo get_the_permalink($object_id)?>"><?php  echo get_the_title($object_id)?></a> </p>
                            <p>
                                <strong><?php echo __('Item Price :' , 'traveler') ; ?></strong> 
