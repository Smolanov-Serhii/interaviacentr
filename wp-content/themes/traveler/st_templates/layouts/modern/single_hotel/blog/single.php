    ...
    <div class="st-single-hotel-modern-page">
        ...
        <div class="sts-banner <?php echo esc_attr($class_bg); ?>">
            <h1 class="page-title sts-pf-font">
                <?php echo esc_html__("Blog", 'traveler');?>
            </h1>
        </div>
        <div class="container">
        	...
        	<div class="row">
                <div class="col-md-12">
                     <?php
                        the_post_navigation( [
                            'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'PRE', 'traveler' ) . '</span> ' . '<img src="'.get_template_directory_uri().'/v2/images/assets/ico_pre.svg">',
                             'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'NEXT', 'traveler' ) . '</span> ' . '<img src="'.get_template_directory_uri().'/v2/images/assets/ico_next.svg">',
                        ] );
                    ?>
