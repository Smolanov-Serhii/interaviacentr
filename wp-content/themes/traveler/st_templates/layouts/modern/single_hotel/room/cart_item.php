        ...
        <ul>
            ...
            <span class="label">
                ...
                <?php echo date_i18n( TravelHelper::getDateFormat(), strtotime( $check_in ) ); ?>
                    ...
                    ?>
                    <a class="st-link" style="font-size: 12px;" href="<?php echo add_query_arg( $args, get_the_permalink( $room_id ) ); ?>"><i class="fa fa-pencil-square-o"></i></a>
            </span>
                <div class="detail">
            ...
            <li class="ad-info">
                <ul>
                    ...
                    <li><span class="label"><?php echo __( 'Number of Room', 'traveler' ); ?></span><span
                            class="value"><?php echo esc_html( $item[ 'number' ] ) . _n( ' Room', ' Rooms', $item[ 'number' ], 'traveler' ); ?></span>
                    </li>
                    <?php if ( $adult_number ) { ?>
                        <li><span class="label"><?php echo __( 'Number of Adult', 'traveler' ); ?></span><span
                                class="value"><?php echo esc_html($adult_number); ?></span></li>
                    <?php } ?>
                    <?php if ( $child_number ) { ?>
                        <li><span class="label"><?php echo __( 'Number of Children', 'traveler' ); ?></span><span
