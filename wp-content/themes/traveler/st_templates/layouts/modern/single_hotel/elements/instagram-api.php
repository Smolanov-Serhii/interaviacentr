...
//   $api = file_get_contents("https://graph.instagram.com/me?fields=id,username&access_token=IGQVJYaTZARSWNDQ0xqOGRLcnFYWDBWOEh6amNOMGFQYXh1Q1kxN2VabTQ5M29XYS1xR205QjQwank0dUg5Sl9RMjRDcVNwWDdyTkpKRHVLSVRRaGp5TFB6a19vclFkT3lYNFBCRmlsREpGcnU0SHBIbgZDZD");      
    ...
    <script type="text/javascript">
        jQuery(function($){
            <?php if(!empty($token_api) && isset($token_api)){?>
                var token = '<?php echo esc_attr($token_api);?>',
                userid = 1362124742,
                num_photos = 5;
            <?php } else {?>
