...
if($style==='style-2'){?>
    <div class="st-service-item">
        <ul class="row">
            ...
            $st_link = vc_build_link($service['link']);
    ...
    <div class="st-service-item style-3">
        <ul class="row">
            <?php foreach ($list_service as $key => $service) {
            ...
            if(isset($icon_image[0])){
             ...
             ?>
                <li class="col-xs-12 col-sm-6 has-matchHeight">
                    <div class="padd-on">
                        <div class="icon text-left">
                            <img src="<?php echo esc_url($icon_image);?>" alt="">
                        </div>
                        <div class="content-text">
                            <h2 class="text-left"><?php echo esc_html($name_service);?></h2>
                            <p class="content-service"><?php esc_html_e( $content_service ) ?></p>
                        </div>
                    </div>
                </li>
            <?php }?>
                            ...
                            <div class="content-text">
                                ...
                                <div class="button-color text-center">
                                    <a href="<?php echo esc_url($st_link);?>" title="<?php echo esc_attr($name_service);?>">
                                        <?php echo esc_html__('DISCOVER', 'traveler'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
