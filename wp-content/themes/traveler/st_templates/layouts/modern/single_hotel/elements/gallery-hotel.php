	...
	<div  class="list-group-slider">
    	...
    	<?php
	        ...
	        <div class="carousel-cell <?php if( $count == 1){?> active <?php }?>">
	            <a class="galleryItem" href="<?php echo esc_url($image_src[0]);?>" data-group="slider"> <img class="group list-group-image" src="<?php echo esc_url($image_src[0]);?>" alt="<?php echo esc_attr($tes_title);?>" /></a>
	        </div>
	    <?php }?>
		</div>
				    ...
				    foreach( $img_ids as $count=>$im_id ){
				     ...
				     <div class="grid-item <?php echo esc_attr($class);?>">
				        <div class="image-masony">
				        	<a class="galleryItem" href="<?php echo esc_url($image_src[0]);?>" data-group="masonry" title=""><img class="group list-group-image" src="<?php echo esc_url($image_src[0]);?>" alt="<?php echo esc_attr($tes_title);?>" /></a>
				        </div>
				    </div>
			    <?php }?>
	    ...
	    <div class="row list-group  st-gallery-grid">
			...
			?>
		        <div class="item  <?php echo esc_attr($class);?>">
		            <div class="thumbnail">
		                <a class="galleryItem" href="<?php echo esc_url($image_src[0]);?>" data-group="grid" title=""><img class="group list-group-image" src="<?php echo esc_url($image_src[0]);?>" alt="<?php echo esc_attr($tes_title);?>" /></a>
		            </div>
		        </div>
		    <?php }?>
	    </div>
