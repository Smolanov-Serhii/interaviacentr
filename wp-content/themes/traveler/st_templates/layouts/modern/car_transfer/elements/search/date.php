...
<div class="form-group form-extra-field form-date-field form-date-search form-date-car clearfix <?php if ($has_icon) echo ' has-icon '; ?>"
    ...
    <div class="date-wrapper clearfix">
        <div class="check-in-wrapper">
            ...
            <div class="render check-in-render"><?php echo esc_html($pick_up_datetext . ', '. $pick_up_time); ?></div>
        </div>
        <div class="check-out-wrapper" style="display:none;">
            <label><?php echo __('Return Time', 'traveler'); ?></label>
            <div class="render check-out-render"><?php echo esc_html($drop_off_datetext.', '. $drop_off_time); ?></div>
            <span>
        </div>
    </div>
