...
<div class="form-group form-passengers-class form-group-<?php echo esc_attr($field_size)?> ">
    ...
    <div class="tp_group_display tp_guests_field">
        <span class="display-guests"><span class="quantity-guests">1</span> <?php echo esc_html__('guest(s)', 'traveler')?></span>
    ...
    <div class="tp-form-passengers-class none">
        <div class="twidget-passenger-form-wrapper">
            <ul class="twidget-age-group guests">
                ...
                <li>
                    <div class="twidget-cell twidget-age-name"><?php echo wp_kses(__('Children to 17<br>years', 'traveler'), array('br'=>array()))?></div>
                    <div class="twidget-cell twidget-age-select">
                        <span class="twidget-num"><input type="text" data-text="<?php echo esc_html__('Age (children', 'traveler'); ?>" class="children" value="0"></span>
                    </div>
                </li>
            </ul>
            <span class="notice none">
                <?php echo esc_html__('You may only search for up to 4 adults and 3 children at a time', 'traveler'); ?>
            </span>
            <hr>
