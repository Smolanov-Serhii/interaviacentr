...
<div data-tp-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <input id="field-hotel-checkin" placeholder="<?php echo strtolower(TravelHelper::getDateFormatJs()); ?>" class="form-control tp_depart_date <?php echo esc_attr($is_required) ?>" readonly value="" type="text" />
