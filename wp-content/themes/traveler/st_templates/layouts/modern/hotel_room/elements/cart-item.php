<?php
    if ( isset( $item_id ) and $item_id ):
        ...
        $extras = isset( $item[ 'data' ][ 'extras' ] ) ? $item[ 'data' ][ 'extras' ] : [];
        ...
        <div class="service-section">
            ...
            <div class="service-right">
                <?php echo get_the_post_thumbnail( $hotel, [ 110, 110, 'bfi_thumb' => true ], [ 'alt' => TravelHelper::get_alt_image( get_post_thumbnail_id( $hotel ) ), 'class' => 'img-responsive' ] ); ?>
            </div>
        </div>
        <div class="info-section">
            ...
            <span class="label">
                ...
                <li class="ad-info">
                    <ul>
                        <li><span class="label"><?php echo __( 'Stay', 'traveler' ); ?></span><span class="value">
                        <?php
                            printf( _n( '%d Night', '%d Nights', $date_diff, 'traveler' ), $date_diff );
                        ?>
                    </span></li>
                        <li><span class="label"><?php echo __( ' Room', 'traveler' ); ?></span><span
                                    class="value"><?php echo esc_html( $item[ 'number' ] ) . _n( ' Room', ' Rooms', $item[ 'number' ], 'traveler' ); ?></span>
                        </li>
                        <?php if ( $adult_number ) { ?>
                            <li><span class="label"><?php echo __( 'Adult', 'traveler' ); ?></span><span
                                        class="value"><?php echo esc_html($adult_number); ?></span></li>
                        <?php } ?>
                        <?php if ( $child_number ) { ?>
                            <li><span class="label"><?php echo __( 'Children', 'traveler' ); ?></span><span
                                        class="value"><?php echo esc_html($child_number); ?></span></li>
                        <?php } ?>
                    </ul>
                </li>
        ...
        <div class="coupon-section">
            ...
            <form method="post" action="<?php the_permalink() ?>">
                ...
                <div class="form-group">
                    ...
                    <?php } else { ?>
                        <button type="submit"
                                class="btn btn-primary"><?php echo __( 'APPLY', 'traveler' ); ?></button>
                    <?php } ?>
                </div>
            </form>
        </div>
        <div class="total-section">
            ...
            <ul>
                ...
                <span class="label text-left">
                    ...
                    <?php } else { ?>
                        <a href="<?php echo st_get_link_with_search( get_permalink(), [ 'remove_coupon' ], [ 'remove_coupon' => STCart::get_coupon_code() ] ) ?>"
                           class="danger"><small class='text-color'>(<?php st_the_language( 'Remove coupon' ) ?>
                                )</small></a>
                    <?php } ?>
                </span>
                        <span class="value">
                ...
                <?php
                    ...
                    <?php echo TravelHelper::format_money( $deposit_price ); ?>
                        ...
                        <li>
                            ...
                            <span
                                    class="value"><?php echo TravelHelper::format_money( $item[ 'data' ][ 'booking_fee_price' ] ); ?></span>
                        </li>
                    <?php } ?>
