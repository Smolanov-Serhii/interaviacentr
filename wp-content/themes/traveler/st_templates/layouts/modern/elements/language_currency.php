...
if (!empty($langs)) {
    ...
    <div class="form-group">
        <label class="block f14 c-grey font-normal"><?php echo esc_html__('Languages', 'traveler'); ?></label>
...
<div class="form-group <?php if ($langs) echo 'mt30'; ?>">
    <label class="block f14 c-grey font-normal"><?php echo esc_html__('Currencies', 'traveler'); ?></label>
        ...
        if (!empty($currency)) {
            foreach ($currency as $key => $value) {
                ...
                <option <?php selected($value['name'], $current_currency['name']) ?>
                        ...
                        data-target="<?php echo esc_url(add_query_arg('currency', $value['name'])) ?>"><?php echo esc_html($value['name']); ?></option>
                <?php
            }
        }
        ?>
