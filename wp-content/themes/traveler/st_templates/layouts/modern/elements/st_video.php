 ...
 * Time: 4:22 PM
 */
$data_video = "{videoURL:'" . esc_attr($link) . "',containment:'.youtube-video',autoPlay:true, showControls:false, showYTLogo: false, mute:false, startAt:0, opacity:1, useOnMobile: true}";
$img_url = '';
