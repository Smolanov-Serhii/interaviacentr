    ...
    <div class="comment-item">
        <div class="comment-item-head">
            ...
            <div class="like">
                ...
                echo '<span>' . esc_html($count_like) . '</span>' . _n( ' like this', ' likes this', $count_like, 'traveler' );
                ?>
        ...
        <div class="comment-item-body">
            ...
            <div class="detail">
                ...
                <div class="st-description"
                    ...
                    <?php echo esc_textarea(balanceTags($content)); ?>
                </div>
                <?php if ( str_word_count( $content ) >= 80 ) { ?>
                    <a href="#" class="st-link block"
                       data-show-target="st-description-<?php echo esc_attr($comment_id); ?>"
                       data-text-less="<?php echo esc_html__( 'Less', 'traveler' ) ?>"
                       data-text-more="<?php echo esc_html__( 'Read more', 'traveler' ) ?>">
                        <span class="text"><?php echo esc_html__( 'Read more', 'traveler' ) ?></span>
