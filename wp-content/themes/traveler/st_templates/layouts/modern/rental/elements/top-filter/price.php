...
<li class="filter-price">
    <div class="form-extra-field dropdown">
        ...
        <div class="dropdown-menu range-slider" aria-labelledby="dropdownMenuFilterPrice">
            <input type="text" class="price_range" name="price_range" value="<?php echo esc_html($value_show); ?>" data-symbol="<?php echo TravelHelper::get_current_currency('symbol'); ?>" data-min="<?php echo esc_attr($min); ?>" data-max="<?php echo esc_attr($max); ?>" data-step="<?php echo st()->get_option('search_price_range_step',0); ?>"/>
