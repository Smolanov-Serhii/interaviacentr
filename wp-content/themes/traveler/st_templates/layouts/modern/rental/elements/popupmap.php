<div class="map-view-popup">
    <div class="container view-map-inner">
        <?php echo st()->load_template('layouts/modern/rental/elements/top-filter/top', 'filter', array('format' => 'popup')); ?>
        <div class="row page-half-map">
            ...
            <div class="col-lg-6 col-md-6 col-left-map col-md-pull-6">
                ...
                <?php echo st()->load_template('layouts/modern/rental/elements/toolbar', '', array('format' => 'popup')); ?>
