...
<div class="row st-woo-cartpage">
    <div class="col-md-8 col-left">
        <form action="<?php echo esc_url(wc_get_cart_url()); //echo esc_url( WC()->cart->get_cart_url() ); ?>"
              method="post">
                ...
                foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
                    ...
                    if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
                        ...
                        <li class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                            ...
                            echo apply_filters('woocommerce_cart_item_remove_link', sprintf('<a class="booking-item-wishlist-remove" href="%s" rel="tooltip" data-placement="top" title="" data-original-title="%s"><i class="fa fa-times"></i></a>
                    ...
                    <td colspan="6" class="actions">
                        ...
                        <?php if (wc_coupons_enabled()) { ?>
                            <div class="coupon">
                                ...
                                <label for="coupon_code"><?php _e('Coupon', 'traveler'); ?>:</label> <input
                                        type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                                        placeholder="<?php _e('Coupon code', 'traveler'); ?>"/> <input type="submit"
                                                                                                          class="btn btn-primary"
                                                                                                          name="apply_coupon"
                                                                                                          value="<?php _e('Apply Coupon', 'traveler'); ?>"/>
                        ...
                        <input type="submit" class="btn btn-primary" name="update_cart"
                               value="<?php _e('Update Cart', 'traveler'); ?>"/>
