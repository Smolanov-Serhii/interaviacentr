		...
		<div class="col-sm-6">
			<div class="col-card-info">
				<div class="form-group">
					<label for="st_twocheckout_card_name"><?php _e('Name on the Card (*)','traveler') ?></label>
					<div class="controls">
						<input type="text" value="" class="form-control" align="" name="st_twocheckout_card_name" id="st_twocheckout_card_name" placeholder="<?php _e('Card name','traveler') ?>">
					</div>
				</div>
				<div class="form-group second">
					<label for="st_twocheckout_card_number"><?php _e('Card number (*)','traveler') ?></label>
					<div class="controls">
						<input type="text" value="" class="form-control" align="" name="st_twocheckout_card_number" id="st_twocheckout_card_number" placeholder="<?php _e('Your card number','traveler') ?>">
					</div>
				</div>
				<div class="card-code-expiry">
					<div class="form-group expiry-date">
						<div class="controls clearfix">
							<div class="form-control-wrap">
								<label for="st_twocheckout_card_expiry_month"><?php _e('Month (*)','traveler') ?></label>
							...
							<div class="form-control-wrap">
                                <label for="st_twocheckout_card_expiry_year"><?php _e('Year (*)','traveler') ?></label>
					...
					<div class="form-group card-code">
						<label for="st_twocheckout_card_code"><?php _e('CVV (*)','traveler') ?></label>
						<div class="controls">
