...
<tr>
	...
	<td align="right" style="padding: 10px 15px;" width="60%"><?php echo esc_html($order_id); ?></td>
</tr>
...
<tr>
	...
	<td align="right" style="padding: 10px 15px;" width="60%"><?php echo esc_html($cancel_data['cancel_percent']).'%'; ?></td>
</tr>
...
<tr>
	...
	<td align="right" style="padding: 10px 15px;" width="60%"><?php echo esc_html($cancel_data['cancel_refund_status']); ?></td>
</tr>
</tbody>
</table>