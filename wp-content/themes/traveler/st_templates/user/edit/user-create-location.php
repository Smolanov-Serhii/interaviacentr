...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group form-group-icon-left">
        <label><?php _e("Content",'traveler') ?></label>
        <?php wp_editor('','st_content'); ?>
    </div>
    <div class="form-group form-group-icon-left">
        <label><?php _e("Description",'traveler') ?></label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <label><?php _e("Parent",'traveler') ?></label>
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                <label><?php _e("Set as Featured",'traveler') ?></label>
        ...
        <div class="col-md-12">
            <div class="form-group form-group-icon-left">
                <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                <label><?php _e("Zip Code", 'traveler') ?></label>
        ...
        <div class="col-md-12">
            <div class="form-group form-group-icon-left">
                ...
                <label><?php _e("Latitude", 'traveler') ?></label>
        ...
        <div class="col-md-12">
            <div class="form-group form-group-icon-left">
                <i class="fa  fa-rocket input-icon input-icon-hightlight"></i>
                <label><?php _e("Longitude", 'traveler') ?></label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                <label><?php _e("Logo",'traveler') ?></label>
        ...
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                <label><?php _e("Featured Image",'traveler') ?></label>
                <div class="input-group">
                    <span class="input-group-btn">
                        <span class="btn btn-primary btn-file">
