...
<div class="row">
    <div class="col-md-8">
            ...
            <div class="form-group form-group-icon-left">
                ...
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_phone' , true)) ?></div>
            </div>
            <?php } ?>
            ...
            <div class="form-group form-group-icon-left">
                ...
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_airport' , true)) ?></div>
            </div>
            <div class="form-group">
                <label><?php st_the_language('user_street_address') ?></label>
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_address' , true)) ?></div>
            </div>
            <div class="form-group">
                <label><?php st_the_language('user_city') ?></label>
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_city' , true)) ?></div>
            </div>
            <div class="form-group">
                <label><?php st_the_language('user_state_province_region') ?></label>
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_province' , true)) ?></div>
            </div>
            <div class="form-group">
                <label><?php st_the_language('user_zip_code_postal_code') ?></label>
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_zip_code' , true)) ?></div>
            </div>
            <div class="form-group">
                <label><?php st_the_language('user_country') ?></label>
                <div class="form-control"><?php echo esc_html(get_user_meta($data->ID , 'st_country' , true)) ?></div>
            </div>
    </div>
</div>
