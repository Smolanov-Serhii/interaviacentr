    ...
    <div class="tab-content" id="myTabContent973">
        <div id="tab-booking-detail" class="tab-pane fade active in">
            <div class="info">
                <div class="row">
                    ...
                    <div class="col-md-12"><strong><?php esc_html_e("Room Name",'traveler') ?>:  </strong>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php echo get_post_meta( $order_id, 'room_num_search', true ); ?>
                    </div>
                    <?php
        ...
        <div id="tab-customer-detail" class="tab-pane fade">
            <div class="container-customer">
                <?php echo st()->load_template('user/detail-booking-history/customer',false,array("order_id"=>$order_id)) ?>
            </div>
        </div>
    </div>
</div>
