...
<div class="author-list-review">
    <h4><?php echo __("List of reviews", 'traveler'); ?></h4>
                                            ...
                                            <div class="stm-dealer-rate-part stm-dealer-rate-part-1">
                                                ...
                                                <div class="author-start-rating">
                                                    <div class="stm-star-rating">
                                                        ...
                                                        <span><strong><?php echo esc_html($v); ?></strong> <?php echo __('out of 5.0', 'traveler'); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <ul class="booking-item-reviews list">
                            ...
                            if (!empty($comments)) {
                                ...
                                $args = array(
                                    ...
                                    'mid_size' => 2,
                                    'prev_next' => true,
                                    'prev_text' => __('&laquo; Previous', 'traveler'),
                                    'next_text' => __('Next &raquo;', 'traveler'),
                                    'type' => 'plain'
                                );
