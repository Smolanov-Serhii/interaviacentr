      			...
      			<div class="panel-body">
	      			<div class="row">
	      				<div class="col-xs-12">
	      					<div class="form-group">
						        <label for="rental_id" class="head_bol"><?php _e('Rental', 'traveler'); ?> <span class="text-small text-danger">(*)</span>:</label>
						        <?php
			                        $rental_id = isset($_POST['item_id']) ? $_POST['item_id'] : '';
      				...
      				<div class="row">
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					<label for="item_price" class="head_bol"><?php _e('Room Origin Price', 'traveler'); ?>:</label>
      				...
      				<div class="row">
      					<div class="col-xs-12 col-sm-4">
      						<div class="form-group">
		      					...
		      					?>
		      						<select name="adult_number" id="adult_number" class="form-control" style="width: 100px;">
      					...
      					<div class="col-xs-12 col-sm-4">
      						<div class="form-group">
		      					...
		      					?>
		      						<select name="child_number" id="child_number" class="form-control" style="width: 100px;">
      				...
      				<div class="row">
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<?php
		      						$check_in = isset($_POST['start']) ? $_POST['start'] : '';
		      					?>
		      					<div class="input-group">
								  	<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="start" id="check_in" value="<?php echo esc_attr($check_in); ?>" class="form-control">
								</div>
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<?php
		      						$check_out = isset($_POST['end']) ? $_POST['end'] : '';
		      					?>
		      					<div class="input-group">
			      					<span class="input-group-addon" id="basic-checkout"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkout" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="end" id="check_out" value="<?php echo esc_attr($check_out); ?>" class="form-control">
							  	</div>
		      				</div>
      					</div>
      				</div>
