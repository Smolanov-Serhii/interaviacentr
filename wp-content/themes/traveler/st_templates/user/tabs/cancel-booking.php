	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				<label for="st_allow_cancel"><?php _e("Allow Cancel",'traveler') ?>:</label>
				<select id="st_allow_cancel" name="st_allow_cancel" class="form-control">
					<option value="off"><?php _e('No','traveler') ?></option>
					<option value="on" <?php selected(STInput::post('st_allow_cancel',get_post_meta($post_id,'st_allow_cancel',true)),'on') ?>><?php _e('Yes','traveler') ?></option>
				</select>
		...
		<div class="col-md-6">
			<div class="form-group">
				<label for="st_cancel_number_days"><?php _e("Number of days before the arrival",'traveler') ?>:</label>
		...
		<div class="col-md-6">
			<div class="form-group">
				<label for="st_cancel_percent"><?php _e("Percent of total price",'traveler') ?>:</label>
                ...
                <i><?php echo sprintf(esc_html__("Your percentage should be more than the commission percentage of the admin. The commission percentage of the admin is %s",'traveler'),$partner_commission."%") ?></i>
