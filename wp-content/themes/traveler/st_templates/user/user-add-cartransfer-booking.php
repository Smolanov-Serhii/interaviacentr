...
?>
<div class="st-create">
    <h2><?php _e("Add New Car Transfer Booking",'traveler') ?></h2>
</div>
      			...
      			<div class="panel-body">
	      			...
	      			<div class="row st_check_book_none">
	      				<div class="col-xs-12">
	      					<div class="form-group">
			                    ...
			                    ?>
			                    <select id="car_id" data-post-type="car_transfer" class="form-control custom-form-control st_post_select_carstransfer_ajax" name="item_id" data-user-id="<?php echo get_current_user_id(); ?>">
      				...
      				<div class="row">
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					<label  for="item_price" class="head_bol"><?php _e('Price', 'traveler'); ?>:</label>
      				...
      				<div class="row">
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					...
		      					<?php
		      						$pick_up_date = isset($_POST['start']) ? $_POST['start'] : '';
		      					?>
		      					<div class="input-group">
								  	<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="start" id="check_in_car" value="<?php echo esc_attr($pick_up_date); ?>" class="form-control">
								</div>
      					...
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					...
		      					<?php
		      						$pick_up_time = isset($_POST['start-time']) ? $_POST['start-time'] : '';
		      					?>
		      					<div class="input-group">
								  	<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="start-time" id="check_in_time" value="<?php echo esc_attr($pick_up_time); ?>" class="st_timepicker form-control">
								</div>
      					...
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					...
		      					<?php
		      						$drop_off_date = isset($_POST['end']) ? $_POST['end'] : '';
		      					?>
		      					<div class="input-group">
								  	<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="end" id="check_out_car" value="<?php echo esc_attr($drop_off_date); ?>" class="form-control">
								</div>
      					...
      					<div class="col-xs-12 col-sm-3">
      						<div class="form-group">
		      					...
		      					<?php
		      						$drop_off_time = isset($_POST['end-time']) ? $_POST['end-time'] : '';
		      					?>
		      					<div class="input-group">
								  	<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
								  	<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="end-time" id="check_out_time" value="<?php echo esc_attr($pick_up_time); ?>" class="st_timepicker form-control">
								</div>
      				...
      				<div class="form-group">
						...
						<input type="hidden" name="car_post_type" value="car_transfer">
						<div class="clearfix">
							<div class="row">
								<div class="col-sm-6">
									<?php
