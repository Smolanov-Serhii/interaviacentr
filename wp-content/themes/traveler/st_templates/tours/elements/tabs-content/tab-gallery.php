...
if(!empty($gallery) && count($gallery_array) > 0){
    echo '<div class="tab-inner-gallery popup-gallery">';

//    if($video = get_post_meta( get_the_ID() , 'video' , true )) {
//        echo "<div class='st-tab-video media-responsive'>" . wp_oembed_get( $video ) . "</div>";
//    }
...
<?php
    ...
    echo '<h4 class="no-photo">'.esc_html__('No photo for this tour', 'traveler').'</h4>';
}