...
$list_name = TravelHelper::get_list_name('st_tours'  , $max_num);
    if($is_required == 'on'){
...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <label for="field-tour-item_id"><?php echo esc_html( $title)?></label>
    <i class="fa  fa-sort input-icon"></i>
   <select id="field-tour-item_id" name="item_id" class="form-control" <?php echo esc_attr($is_required) ?>>
