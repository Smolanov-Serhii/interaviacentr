...
<tr>
    ...
    <td>
        ...
        <?php }?>
        <?php if($adult_number){?>
        <p><strong><?php _e('Number of Adult','traveler') ?>: </strong>
            <?php echo esc_html($adult_number); ?>
        </p>
        <?php } ?>
        <?php if($child_number){?>
        <p><strong><?php _e('Number of Children','traveler') ?>: </strong>
            <?php echo esc_html($child_number); ?>
        </p>
        <?php }?>
        <?php if($infant_number){?>
        <p><strong><?php _e('Number of Infant','traveler') ?>: </strong>
        ...
        if($tour_price_type != 'fixed_depart') {
            ...
            echo '<p><strong>'. __('Tour type', 'traveler') .'</strong>: '. __('Fixed Departure', 'traveler') .'</p>';
	        ?>
	        <?php if ( $check_in ) { ?>
                <p>
                    <strong><?php echo __('Start', 'traveler') ?>: </strong>
                    <?php
	        ...
	        <?php if ( $check_out ) { ?>
                <p>
                    <strong><?php echo __('End', 'traveler') ?>: </strong>
	                <?php
