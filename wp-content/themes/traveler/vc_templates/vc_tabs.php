...
// Extract tab titles
    ...
    if($tab_style == "single_tab"){
        ...
        if ( 'vc_tour' == $this->shortcode ) {
            $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'traveler' ) . '">' . __( 'Previous tab', 'traveler' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'traveler' ) . '">' . __( 'Next tab', 'traveler' ) . '</a></span></div>';
        }
