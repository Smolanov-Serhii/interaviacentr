                ...
                if (isset(STTravelCode::$plugins_data['Version'])) {
                    ...
                    if (version_compare('1.3.2', $version, '>')) {
                        ...
                        <div class="error settings-error notice is-dismissible">
                            ...
                            <p>
                                <?php printf(__('<strong>Payu</strong> require %s version %s or above. Your current is %s', 'traveler'), '<strong><em>' . __('Traveler Code', 'traveler') . '</em></strong>', '<strong>1.3.2</strong>', '<strong>' . $version . '</strong>'); ?>
                            </p>
                            <p>
        ...
        function get_option_fields()
        {
            return array(
                array(
                    ...
                    'desc' => __('Your Payu Merchant ID', 'traveler'),
                    'condition' => 'pm_gway_st_payu_enable:is(on)'
                ),
                array(
                    'id' => 'payu_salt_key',
                    'label' => __('Salt Key', 'traveler'),
                    'type' => 'text',
                    'section' => 'option_pmgateway',
                    'desc' => __('Your Payu Salt Key', 'traveler'),
                    'condition' => 'pm_gway_st_payu_enable:is(on)'
                ),
                array(
