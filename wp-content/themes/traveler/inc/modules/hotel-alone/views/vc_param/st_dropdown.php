				...
				switch ( $stype ) {
					case 'tax':
						foreach ( $list as $k => $v ) {
                            ...
                            <option class=""
                                    value="<?php echo esc_attr($v); ?>" <?php echo ($selected); ?> ><?php echo esc_html( $k ); ?></option>
							<?php
						}
						break;
					case 'post_type':
						foreach ( $list as $k => $v ) {
                            ...
                            <option class=""
                                    value="<?php echo esc_attr($v['value']); ?>" <?php echo ($selected); ?> ><?php echo esc_html( $v['label'] ); ?></option>
							<?php
						}
						break;
				}
