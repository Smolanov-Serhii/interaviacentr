    ...
    if(is_user_logged_in()){
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu <?php if($is_account_sub_menu == 'off') echo "hide"; ?>">
                ...
                <li><a href="<?php echo esc_url($setting_link) ?>"><i class="fa fa-cog"></i> <?php esc_html_e("Account settings",'traveler') ?></a></li>

                <li><a href="<?php echo esc_html($url_logout) ?>"><i class="fa fa-power-off"></i> <?php esc_html_e("Log out",'traveler') ?></a></li>
    ...
    <?php }else{
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu register-user">
                ...
                <li><a  class="" <?php echo ($login_modal); ?>  href="<?php echo ($page_login) ?>"><?php echo __("Login", 'traveler');?></a></li>
