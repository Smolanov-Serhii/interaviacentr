...
<div class="topbar-content top-bar-style-1" data-offset="0">
    ...
    <div class="control-left">
        ...
        <div class="option-item">
            ...
            <div class="option-mid">
                ...
                <span class="btn-book"><?php esc_html_e("RESERVATION",'traveler') ?></span>

            </div>

            <div class="form-search-position-left">
                ...
                <div class="form-search-content">
                    ...
                    <div class="form-search-content-mid">
                        ...
                        <div class="background_booking">
                            ...
                            <?php esc_html_e("Booking",'traveler') ?>
