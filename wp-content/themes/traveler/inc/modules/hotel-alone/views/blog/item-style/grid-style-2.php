...
<div class="st-post-grid style-2 <?php echo ($index%2 == 0?'even-item':'')?>">
    ...
    <div class="caption-post">
        ...
        <div class="author">
            ...
            <span class="name"><?php echo esc_html__('BY', 'traveler')?> &nbsp;<span class="main-color"><?php echo get_the_author_meta('user_login'); ?></span></span>

        </div>

        <a href="<?php the_permalink(); ?>" class="read-more"><?php echo esc_html__('Read more', 'traveler')?> <i class="fa fa-long-arrow-right"></i></a>
