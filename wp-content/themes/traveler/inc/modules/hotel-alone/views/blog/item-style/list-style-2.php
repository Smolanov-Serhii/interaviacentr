<div <?php post_class('st-post-list style-2') ?>>
    ...
    <div class="blog-item-meta-footer">
        ...
        <div class="blog-item-link">
            ...
            <a href="<?php the_permalink(); ?>" class="btn-bg-black btn-size-0"><?php esc_html_e('CONTINUE READING','traveler');?> <i class="fa fa-long-arrow-right"></i></a>
        ...
        <div class="blog-item-meta">
            ...
            if(is_sticky(get_the_ID())){
                ...
                echo '<span class="sticky"><i class="fa fa-thumb-tack"></i> '.esc_html__('Sticky', 'traveler').'</span>';
