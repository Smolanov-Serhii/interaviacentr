...
<div id="st-form-booking-room" class="st-form-booking-room style-1">
    ...
    <form class="wpbooking-search-form-wrap wpbooking_order_form form-has-guest-name"  action="<?php echo get_the_permalink(get_the_ID()); ?>">
        ...
        <input name="item_id" value="<?php echo esc_attr($service_id); ?>" type="hidden">
        ...
        <div class="guest_name_input hidden mb15 mt10" data-placeholder="<?php esc_html_e('Guest %d name','traveler') ?>" data-hide-children="<?php echo get_post_meta(get_the_ID(),'disable_children_name',true) ?>" data-hide-infant="<?php echo get_post_meta(get_the_ID(),'disable_infant_name',true) ?>">
        ...
        <div class="control">
            ...
            <div class="phone">
                ...
                <div class="helios-more-extra">
                    ...
                    <span class="btn_extra"><?php esc_html_e("Extra services",'traveler') ?> <i class="fa fa-angle-down"></i> </span>

                </div>

                <?php if(!empty($phone)){ ?>

                    <div class="title"><?php esc_html_e("RESERVATION HOTLINE",'traveler') ?></div>

                    <div class="number"><?php echo esc_html($phone) ?></div>
