...
<div class="item-room loop-room post-<?php the_ID() ?> loop-room-style-1">
    ...
    <div class="room-content">
        ...
        <div class="room-guest">
            ...
            if (!empty($number_adult) || !empty($number_child)) {
                ...
                <span><?php echo esc_attr($number_adult + $number_child); ?> <?php esc_html_e("GUESTS", 'traveler') ?></span>
        ...
        <div class="price">
            ...
            <span class="title"><?php esc_html_e("PRICE", 'traveler') ?></span>
            ...
            if ($start != '' && $end != '') {
                ...
                <span class="small">
                         ...
                         if ($numberday > 1) {
                             ...
                             echo sprintf(esc_html__("/ %s nights", 'traveler'), $numberday);

                         } else {

                             echo sprintf(esc_html__("/ %s night", 'traveler'), $numberday);
            ...
            <?php } else { ?>
                ...
                <span class="small"><?php esc_html_e("/night", 'traveler') ?></span>
    ...
    <div class="room-book">
        ...
        <div class="helios-more-extra">
            ...
            <?php if (!empty($list_extra)) {
                ...
                <span class="btn_extra">
                    ...
                    <?php esc_html_e("Extra services", 'traveler') ?>
        ...
        <form class="form-booking-inpage hotel-alone-booking-inpage" class="" method="post">
            ...
            <input type="hidden" name="start" value="<?php echo esc_attr($check_in); ?>"/>

            <input type="hidden" name="end" value="<?php echo esc_attr($check_out); ?>"/>
            ...
            <div class="options">
                ...
                if ($external_booking == 'off') {
                    ...
                    <?php //if ($start != '' && $end != '' && $is_minimum_stay) { ?>
                        ...
                        <div class="room-number">
                            ...
                            <select class="form-control option_number_room"
                                ...
                                <option value="-1"><?php esc_html_e("Select Room", 'traveler') ?></option>
                    ...
                    if ($st_is_booking_modal && !$st_is_woocommerce_checkout) {
                        ...
                        <a class="btn-hotel-alone-st-add-cart" data-effect="mfp-zoom-out" onclick="return false"
                           ...
                           type="submit"><?php echo __('Book Now', 'traveler'); ?> <i class="fa fa-spinner fa-spin"></i></a>
                        ...
                        <button class="btn btn-primary btn-loading btn_hotel_booking btn-hotel-alone-booking"
                                ...
                                value="" type="submit"><?php echo __('Book Now', 'traveler'); ?></button>
                    ...
                    <a href="<?php echo esc_url($external_booking_link) ?>" data-toggle="tooltip"
                       ...
                       title="<?php esc_html_e('External Booking', 'traveler'); ?>">

                        <?php esc_html_e("Book now", 'traveler') ?> <i class="fa fa-external-link"></i>
                ...
                <div class="clearfix guest_name_input mb15 mt30" data-placeholder="<?php esc_html_e('Guest %d name','traveler') ?>" data-hide-children="<?php echo get_post_meta(get_the_ID(),'disable_children_name',true) ?>" data-hide-infant="<?php echo get_post_meta(get_the_ID(),'disable_infant_name',true) ?>">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="name">
                                ...
                                <?php esc_html_e("Service name", 'traveler') ?>

                            </td>

                            <td class="text-center quantity">

                                <?php esc_html_e("Quantity", 'traveler') ?>
                            ...
                            <td class="text-center">
                                ...
                                echo sprintf(esc_html__("Price (%s)", 'traveler'), TravelHelper::get_current_currency('name'))
                        ...
                        <?php foreach ($list_extra as $k => $v) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="extra_price[price][<?php echo esc_attr($v['extra_name']) ?>]" value="<?php echo esc_attr($v['extra_price']); ?>" />

                                    <input type="hidden" name="extra_price[title][<?php echo esc_attr($v['extra_name']) ?>]" value="<?php echo esc_attr($v['title']); ?>" />
