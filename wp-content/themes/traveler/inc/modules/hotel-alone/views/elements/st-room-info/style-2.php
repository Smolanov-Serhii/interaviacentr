<div class="helios-room-info style-2">
        ...
        if ( get_post_meta( get_the_ID(), 'price_by_per_person', true ) == 'on' ) : ?>
            ...
            <div class="guest info-price">
                ...
                <div class="price">
                    ...
                    echo TravelHelper::format_money($adult_price); ?><br><span class="small"><?php esc_html_e("/person/night", 'traveler') ?></span>
            ...
            <div class="guest info-price">
                ...
                <div class="price">
                    ...
                    echo TravelHelper::format_money($child_price); ?><br><span class="small"><?php esc_html_e("/person/night", 'traveler') ?></span>
