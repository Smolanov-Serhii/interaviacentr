...
$data_video = "{videoURL:'".$link."',containment:'.youtube-video',autoPlay:true, showControls:false, showYTLogo: false, mute:false, startAt:0, opacity:1, useOnMobile: true}";
                ...
                <div class="table-cell">
                    ...
                    <div class="caption">
                        ...
                        <div class="st-play">
                            ...
                            <span class="label-left <?php echo esc_attr($label_color); ?>"><?php echo esc_html__('CLICK THE PLAYER TO', 'traveler') ?></span>
                            ...
                            <span
                                ...
                                class="label-right <?php echo esc_attr($label_color); ?>"><?php echo esc_html__('WATCH THE OVERVIEW', 'traveler') ?></span>
