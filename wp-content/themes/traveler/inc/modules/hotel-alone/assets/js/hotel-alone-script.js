(function ($) {
    "use strict";
    $('.topbar  .top-bar-style-2 .room_book').on('click', function () {
        $(this).closest('.option-item').find('.form-search-position-right').toggleClass('active');
    });
    $('.topbar  .top-bar-style-1 .btn-book').on('click', function () {
        $(this).closest('.option-item').find('.form-search-position-left').toggleClass('active');
    });
    $('.topbar  .top-bar-style-1 .btn-close').on('click', function () {
        $(this).closest('.option-item').find('.form-search-position-left').toggleClass('active');
    });
    $('.topbar  .top-bar-style-4 .btn-book').on('click', function () {
        $(this).closest('.option-item').find('.form-search-position-left').toggleClass('active');
    });
    $('.topbar  .top-bar-style-4 .btn-close').on('click', function () {
        $(this).closest('.option-item').find('.form-search-position-left').toggleClass('active');
    });
    $('.wpbooking-search-form-wrap .helios-options-number .fa-angle-up').on('click', function () {
    ...
    $('.wpbooking-search-form-wrap .helios-options-number .fa-angle-down').on('click', function () {
        var parent = $(this).closest('.item-search-content');
        var value  = parent.find('.helios-number').val();
        value      = parseInt(value) - 1;
    ...
    $('.wpbooking-search-form-wrap .options').on('click', function () {
        $(this).closest('.date-group').find('.wpbooking-check-in-out').trigger('click');
    });
    $('.wpbooking-search-form-wrap .wpbooking-date-start').on('change', function () {
        var parent = $(this).closest('.item-search-content');
    ...
    $('.wpbooking-search-form-wrap .wpbooking-date-end').on('change', function () {
        var parent = $(this).closest('.item-search-content');
    ...
    $('.st-list-feature-hotel-room.style-3 .caurolselWrapRoom').each(function () {
        ...
        setTimeout(function () {
            ...
            parent.find('.ButtonDiscover').on('click', function () {
                owl.trigger('prev.owl.carousel', [300]);
            })
            parent.find('.ButtonNextsDiscover').on('click', function () {
                owl.trigger('next.owl.carousel');
            });
        }, 500);
    });
    $('.st-list-feature-hotel-room.style-1').each(function () {
        ...
        $this.find('.listRoom .Room').on('click', function () {
    ...
    $('.st-form-reservation-room .helios-btn-do-search-room').on('click', function () {
    ...
    $('.st-form-booking-room .btn_extra').on('click', function () {
        var parent = $(this).closest('.st-form-booking-room');
        var $extra = parent.find('.list-extra');
        $extra.toggleClass('active');
    });
    $('.hotel-alone-booking-now').on('click', function (e) {
        e.preventDefault();
        var me = $(this);
