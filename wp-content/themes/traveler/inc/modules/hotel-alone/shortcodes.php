                ...
                elseif ($type == 'isotope'){
                    ...
                    if($load_more == 'yes'){
                        ...
                        $text = array(
                            ...
                            'load_more' => esc_html__('Load more', 'traveler'),
                            'no_more' => esc_html__('No more', 'traveler')
                        );
                        $output .= '<a href="#"
                                        ...
                                        data-index = "'.$index.'"
                                        >
                                        '.(((int)$blog_query->max_num_pages == 1)? esc_html__(  'No More' , 'traveler' ): esc_html__(  'Load More' ,'traveler' )).'
                                    </a>
                                    ';
                        $output .= '</div>';
                    }
