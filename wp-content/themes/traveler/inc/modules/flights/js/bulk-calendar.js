jQuery(function ($) {
    ...
    if ($('#flight-form-bulk-edit').length) {
        $('#flight-form-bulk-edit #calendar-bulk-close').on('click', function (event) {
            $(this).closest('#flight-form-bulk-edit').fadeOut();
            if ($('.calendar-bulk-room-close').length) {
            } else {
                $(this).closest('.calendar-wrapper').trigger('flight.calendar.refetchEvents');
            }
        })
    }
    $('#flight-calendar-bulk-edit').on('click', function (event) {
        if ($('#flight-form-bulk-edit').length) {
    ...
    if ($('#flight-form-bulk-edit').length) {
        $('#flight-form-bulk-edit #calendar-bulk-save').on('click', function (event) {
