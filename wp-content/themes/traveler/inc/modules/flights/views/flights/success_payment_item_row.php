...
if(!empty($depart_data_location)){
    ...
    if($flight_type == 'return'){
        ...
        $item .= esc_html__(' (Return)', 'traveler');
...
<tr>
    ...
    <td>
        ...
        <p><strong><?php echo esc_html__('Depart Flight Price', 'traveler') ?></strong> <?php echo TravelHelper::format_money($depart_price); ?></p>

        <p><strong><?php echo esc_html__('Depart Date', 'traveler') ?></strong> <?php echo date_i18n(TravelHelper::getDateFormat(), ($check_in)) ?></p>
        ...
        ?>
            ...
            <p><strong><?php echo esc_html__('Return Flight Price', 'traveler') ?></strong> <?php echo TravelHelper::format_money($return_price); ?></p>

        <p><strong><?php echo esc_html__('Return Date', 'traveler') ?></strong> <?php echo date_i18n(TravelHelper::getDateFormat(), ($check_out)) ?></p>
