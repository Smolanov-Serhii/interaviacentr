...
<ul class="booking-list  depart st-booking-list-flight" data-flight_type="<?php echo ($on_way?'on_way':'return'); ?>">
    ...
    <li data-external="<?php echo esc_html($external); ?>" data-external-link="<?php echo esc_url($external_link); ?>" data-external-text="<?php echo esc_html('External Booking', 'traveler'); ?>">
