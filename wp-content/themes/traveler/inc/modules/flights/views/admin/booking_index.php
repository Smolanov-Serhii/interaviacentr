<?php
    ...
    echo '<h2>' . __( 'Flight Booking', 'traveler' ) . '</h2>';
    ...
    <table class="wp-list-table widefat fixed posts">
        ...
        <tr>
            ...
            <th class="manage-column" width="10%">
                ...
                <a href="#"><span><?php _e( 'Execution Time', 'traveler' ) ?></span><span class="sorting-indicator"></span></a>

            </th>

            <th class="manage-column">

                <a href="#"><span><?php _e( 'Flight Detail', 'traveler' ) ?></span><span
                    ...
                    <tr class="<?php if ( $i % 2 == 0 ) echo 'alternate'; ?>">
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <div class="row-actions">
                                ...
                                <a href="<?php echo admin_url( 'edit.php?post_type=st_flight&page=st_flight_booking&section=edit_order_item&order_item_id=' . $post_id ); ?>"><?php _e( 'Edit', 'traveler' ) ?></a>

                                |

                                <a href="<?php echo admin_url( 'edit.php?post_type=st_flight&page=st_flight_booking&section=resend_email_flight&order_item_id=' . $post_id ); ?>"><?php _e( 'Resend Email', 'traveler' ) ?></a>
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            if($flight_type == 'return'){
                                ...
                                echo '<span>('.esc_html__('Round Trip', 'traveler').')</span>';
