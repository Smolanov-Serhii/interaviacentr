<?php
    ...
    if ( !isset( $page_title ) ) {
        ...
        $page_title = __( 'Edit Flight Booking', 'traveler' );
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label"
                                           ...
                                           for=""><?php _e( 'Title Flight', 'traveler' ) ?></label>
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label" for="check_in">
                                        ...
                                        <?php _e( 'Departure Time', 'traveler' ) ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <strong><?php echo esc_html($passenger); ?></strong>
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label" for="">
                                        ...
                                        <?php _e( 'Departure Price', 'traveler' ) ?>
