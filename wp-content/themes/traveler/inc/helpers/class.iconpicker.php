...
if(!class_exists('ST_Icon_Picker'))
{
    class ST_Icon_Picker
    {
        static function _init()
        {
	        ...
	        add_action('admin_enqueue_scripts', array(__CLASS__, '_add_script_icon_picker'));
            add_action('wp_enqueue_scripts',array(__CLASS__,'_add_script'));
        }

        static function _add_script()
        {
            $string_icons = '.fa-glass:before {
              content: "\f000";
            }
            .fa-music:before {
              content: "\f001";
            ...
            preg_match_all("/fa-.*:/", $string_icons, $arr_icons);

            if( !empty( $arr_icons ) ){
                $arr_icons = $arr_icons[0];
	    ...
	    static function _add_script_icon_picker(){
		    wp_enqueue_style('fontawesome', get_template_directory_uri().'/css/font-awesome.css');
		    wp_enqueue_script('iconpicker', get_template_directory_uri().'/js/iconpicker/js/fontawesome-iconpicker.min.js', array('jquery'), '1.0', true );
		    wp_enqueue_style('iconpicker-css',get_template_directory_uri().'/js/iconpicker/css/fontawesome-iconpicker.css');
	    }
