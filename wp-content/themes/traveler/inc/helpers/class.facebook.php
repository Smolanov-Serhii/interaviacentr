...
//            STTemplate::set_message(__('Sorry! We can not get your Facebook User Email. Please try again later','traveler'),'danger');
//            return;
//        }
//
//        //Try Login
...
//        if($email_founded){
//            STTemplate::set_message(sprintf(__('The Email: %s was used already. Please try with other facebook account.','traveler'),$data['email']));
//            return;
//        }
//
//        // If Not, Register
