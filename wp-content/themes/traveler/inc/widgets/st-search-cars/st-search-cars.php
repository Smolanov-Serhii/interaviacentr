<?php
    ...
    if(!class_exists('st_widget_search_cars')){

        class st_widget_search_cars extends WP_Widget{



            public $cache_key='st_widget_search_cars';



            public function __construct() {

                $widget_ops = array('classname' => 'st_widget_search_cars', 'description' => __( "Cars Filter Box",'traveler') );

                parent::__construct('st_widget_search_cars', __('ST Cars Filter Box','traveler'), $widget_ops);
...

            {
                ...
                if($screen->base=='widgets'){
                    ...
                    wp_enqueue_script('search-cars',get_template_directory_uri().'/js/admin/widgets/search-cars.js',array('jquery','jquery-ui-sortable'),null,true);

                    wp_enqueue_style('search-hotel',get_template_directory_uri().'/css/admin/widgets/search-hotel.css',array('jquery-ui'));



                    wp_localize_script('search-cars','st_search_cars',array(
            ...
            public function widget($args, $instance) {
                ...
                echo st()->load_template('cars/filter',null,array(
            ...
            function default_item($key=0,$old=array()){
                ...
                $tax=get_object_taxonomies('st_cars','object');
            ...
            public function form( $instance ) {
                ...
                <p><label for="<?php echo esc_attr($this->get_field_id( 'st_style' )); ?>"><?php _e( 'Style:','traveler'  ); ?></label>
                    ...
                    <select class=" widefat field_name" id="<?php echo esc_attr($this->get_field_id( 'st_style' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'st_style' )); ?>">
                        ...
                        <option <?php if($st_style == 'light') echo 'selected'; ?>  value="light">Light</option>

                        <option <?php if($st_style == 'dark') echo 'selected'; ?> value="dark">Dark</option>
                ...
                <div class="st-search-fields">
                    ...
                    <a href="#" class="button st_add_field_cars" onclick="return false;"><?php _e('Add New','traveler')?></a>

                    <a href="#" class="button st_save_fields_cars" onclick="return false;"><?php _e('Save List','traveler')?></a>
        ...
        function st_search_cars_widget_register() {

            if(st_check_service_available('st_cars'))

            register_widget( 'st_widget_search_cars' );

        }



        add_action( 'widgets_init', 'st_search_cars_widget_register' );
