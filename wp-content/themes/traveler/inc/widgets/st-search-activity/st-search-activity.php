    ...
    if(!class_exists('st_widget_search_activity')){
        ...
        class st_widget_search_activity extends WP_Widget{
            ...
            public function __construct() {
                ...
                $widget_ops = array('classname' => 'st_widget_search_activity', 'description' => __( "Activity Filter Box",'traveler') );

                parent::__construct('st_widget_search_activity', __('ST Activity Filter Box','traveler'), $widget_ops);
            ...
            public function form( $instance ) {
                ...
                <p><label for="<?php echo esc_attr($this->get_field_id( 'st_style' )); ?>"><?php _e( 'Style:' ,'traveler' ); ?></label>
                    ...
                    <select class=" widefat field_name" id="<?php echo esc_attr($this->get_field_id( 'st_style' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'st_style' )); ?>">
                        ...
                        <option <?php if($st_style == 'light') echo 'selected'; ?>  value="light"><?php _e('Light','traveler')?>,</option>

                        <option <?php if($st_style == 'dark') echo 'selected'; ?> value="dark"><?php _e('Dark','traveler')?></option>
                ...
                <div class="st-search-fields">
                    ...
                    <a href="#" class="button st_add_field_activity" onclick="return false;"><?php _e('Add New','traveler')?></a>

                    <a href="#" class="button st_save_fields_activity" onclick="return false;"><?php _e('Save List','traveler')?></a>
