...
//                    );
                    ...
                    if (!isset($twitters['errors']) && count($twitters)>0 and is_array($twitters)) {
                        ...
                        foreach( $twitters as $twitter ) {
                            ...
                            ob_start();
                                ...
                                printf( __( '%s ago', 'traveler' ), human_time_diff( strtotime($twitter['created_at'])  , current_time( 'timestamp' ) ) );
            ...
            public function form( $instance ) {
                ...
                <p>
                    ...
                    <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:','traveler' ); ?></label>
                ...
                <p>
                    ...
                    <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php _e( 'Twitter User:','traveler' ); ?></label>
                ...
                <p>
                    ...
                    <label for="<?php echo esc_attr($this->get_field_id( 'number_tweet' )); ?>"><?php _e( 'Number of Tweet (default is 5):','traveler' ); ?></label>
