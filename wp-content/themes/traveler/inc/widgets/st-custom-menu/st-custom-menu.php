...
if (!class_exists('ST_Nav_Menu_Widget')) {
    ...
    class ST_Nav_Menu_Widget extends WP_Widget {
        ...
        public function __construct() {
            ...
            $widget_ops = array('description' => __('Add a custom menu to your sidebar.', 'traveler'));

            parent::__construct('st_nav_menu', __('ST Custom Menu', 'traveler'), $widget_ops);
        ...
        public function form($instance) {
            ...
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>"><?php _e('Select Menu:', 'traveler'); ?></label>

                <select id="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>" name="<?php echo esc_html($this->get_field_name('nav_menu')); ?>">

                    <option value="0"><?php _e('&mdash; Select &mdash;', 'traveler') ?></option>
