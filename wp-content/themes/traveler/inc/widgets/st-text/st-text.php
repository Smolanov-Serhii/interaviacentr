...
if(!class_exists('st_wd_text')){
    ...
    class st_wd_text extends WP_Widget{
        ...
        public function __construct() {
            ...
            $widget_ops = array('classname' => 'st_wd_text', 'description' => __( "Text sidebar with traveler header style and can be shortcodes in content ",'traveler') );

            parent::__construct('st_wd_text', __('ST Text','traveler'), $widget_ops);
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('style')); ?>"><?php _e('Style:'); ?>

                <select name="<?php echo esc_attr($this->get_field_name('style')); ?>" id="<?php echo esc_attr($this->get_field_id('style')); ?>">

                    <option <?php if (esc_attr($style) =='') echo "selected"; ?> value=""><?php echo __("Default" ,'traveler') ;?></option>

                    <option <?php if (esc_attr($style) =='tour_box') echo "selected"; ?> value="tour_box"><?php echo __("Tour box style" , 'traveler');?></option>
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php _e('Content:'); ?> <textarea class="widefat" id="<?php echo esc_attr($this->get_field_id('content')); ?>" name="<?php echo esc_attr($this->get_field_name('content')); ?>" type="text"><?php echo esc_attr($content); ?></textarea></label></p>
