    ...
    if(!class_exists('st_recent_comment')){
        ...
        class st_recent_comment extends WP_Widget {
            ...
            public function __construct() {
                ...
                parent::__construct('recent-comments', __('ST Recent Comments','traveler'));
            ...
            public function widget( $args, $instance ) {
                ...
                $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Comments','traveler' );
                ...
                if ( $comments ) {
                    ...
                    foreach ( (array) $comments as $comment) {
                        ...
                        <p class="thumb-list-item-meta"><a href="'.esc_url( get_comment_link( $comment->comment_ID ) ).'">'.human_time_diff( get_comment_time('U'), current_time('timestamp') ) . __(' ago','traveler').'</a> </p>

                        <h4 class="thumb-list-item-title">

                        '.sprintf( __( '%s', 'traveler' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ).'
            ...
            public function form( $instance ) {
                ...
                <p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php _e( 'Number of comments to show:','traveler' ); ?></label>
