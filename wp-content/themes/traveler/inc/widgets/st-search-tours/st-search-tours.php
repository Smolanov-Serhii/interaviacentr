...
if (!class_exists('st_widget_search_tour')) {



    class st_widget_search_tour extends WP_Widget {



        public $cache_key = 'st_widget_search_tours';



        public function __construct() {

            $widget_ops = array('classname' => 'st_widget_search_tours', 'description' => __("Tour Filter Box", 'traveler'));

            parent::__construct('st_widget_search_tour', __('ST Tour Filter Box', 'traveler'), $widget_ops);
        ...
        function add_scripts() {
            ...
            if ($screen->base == 'widgets') {
                ...
                wp_enqueue_script('search-tour', get_template_directory_uri() . '/js/admin/widgets/search-tours.js', array('jquery', 'jquery-ui-sortable'), null, true);

                wp_enqueue_style('search-tour', get_template_directory_uri() . '/css/admin/widgets/search-hotel.css', array('jquery-ui'));



                wp_localize_script('search-tour', 'st_search_tour', array(
        ...
        public function widget($args, $instance) {
            ...
            echo st()->load_template('tours/filter', null, array(
        ...
        function default_item($key = 0, $old = array()) {
            ...
            $tax = get_object_taxonomies('st_tours', 'OBJECTS');
            ...
            <div class="st-search-fields">
                ...
                <div class="fields-form" onsubmit="return false">
                    ...
                    <ul class="fields-wrap">
                        ...
                        $list = json_decode($st_search_fields);
                ...
                <a href="#" class="button st_add_field_tours" onclick="return false;"><?php _e('Add New', 'traveler') ?></a>

                <a href="#" class="button st_save_fields_tours" onclick="return false;"><?php _e('Save List', 'traveler') ?></a>
    ...
    add_action('widgets_init', 'st_search_tour_widget_register');
