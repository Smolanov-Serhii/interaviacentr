    ...
    if(!class_exists('st_widget_list_post')){
        ...
        class st_widget_list_post extends WP_Widget{
            ...
            public function __construct() {
                ...
                $widget_ops = array('classname' => 'widget_st_list_entries', 'description' => __( "Your site&#8217;s list posts.",'traveler') );

                parent::__construct('st_widget_list_post', __('ST List Posts','traveler'), $widget_ops);
            ...
            public function widget($args, $instance) {
                ...
                $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Posts','traveler' );
            ...
            public function form( $instance ) {
                ...
                <p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php _e( 'Number of posts to show:','traveler' ); ?></label>
                ...
                <p><input class="checkbox" type="checkbox" <?php checked( $show_date ); ?> id="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_date' )); ?>" />
                    ...
                    <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php _e( 'Display post date?','traveler' ); ?></label></p>



                <p>

                    <label for="<?php echo esc_attr($this->get_field_id( 'orderby' )); ?>"><?php _e( 'Order By','traveler' ); ?></label>
                ...
                <p>
                    ...
                    <label for="<?php echo esc_attr($this->get_field_id( 'order' )); ?>"><?php _e( 'Order','traveler' ); ?></label>

                    <select name="<?php echo esc_attr($this->get_field_name( 'order' )); ?>">

                        <option <?php selected($order,"ASC");?> value="ASC"><?php echo __('ASC','traveler')?></option>

                        <option <?php selected($order,"DESC");?> value="DESC"><?php echo __('DESC','traveler')?></option>
