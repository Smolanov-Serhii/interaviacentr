...
if (!class_exists('st_search_blog')){
    ...
    class st_search_blog extends WP_Widget {
        ...
        public function __construct() {
            ...
            parent::__construct( 'st_search_blog',__("ST Search Blog" , 'traveler'), $widget_ops );
        ...
        public function form( $instance ) {
            ...
            <p><label for="<?php echo esc_attr( $this->get_field_id('is_button')); ?>"> <?php echo __("Show Icon Search ", 'traveler' ); ?>:

                <input type="radio" id = "<?php echo esc_attr($this->get_field_id('is_button')); ?>" name="<?php echo esc_attr($this->get_field_id('is_button')); ?>" value="yes" <?php if ($instance['is_button'] =='yes'){ echo "checked" ; }?>> <?php echo __("Yes", 'traveler' ) ; ?>

                <input type="radio" id = "<?php echo esc_attr($this->get_field_id('is_button')); ?>" name="<?php echo esc_attr($this->get_field_id('is_button')); ?>" value="no"  <?php if ($instance['is_button'] =='no'){ echo "checked" ; }?>> <?php echo __("No", 'traveler' ) ; ?>
