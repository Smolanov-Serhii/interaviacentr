                        ...
                        case 'image_upload':
                            ...
                            switch ($type) {
                                ...
                                case 'application/javascript':
                                    ...
                                    $text_info .= '<i class="fa fa-download" aria-hidden="true"></i> <a download href="'. wp_get_attachment_url($field_meta) .'">'. __('Download file', 'traveler') .'</a> ';
                            ...
                            echo esc_html($text_info) . wp_get_attachment_image($field_meta, $size_image, true);
