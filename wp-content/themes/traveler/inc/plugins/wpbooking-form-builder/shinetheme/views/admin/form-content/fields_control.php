                        ...
                        switch($key){
                            ...
                            case 'basic':
                                ...
                                <li class="control-section accordion-section add-form-fields open">
                                    ...
                                    <h3 class="accordion-section-title hndle"><?php echo esc_html__('Basic fields', 'traveler') ?></h3>
                                            ...
                                            <div class="posttypediv">
                                                ...
                                                <span class="list-controls">
                                                    ...
                                                    <a href="#" class="select-all-builder"
                                                       ...
                                                       role="button"><?php echo esc_html__('Select All', 'traveler') ?></a>
                                                ...
                                                <span class="add-to-menu">
                                                    ...
                                                    <input type="submit" class="button submit-add-to-form right"
                                                           ...
                                                           value="<?php echo esc_html__('Add to form', 'traveler'); ?>"
                            ...
                            case 'user':
                                ...
                                <li class="control-section accordion-section add-form-fields">
                                    ...
                                    <h3 class="accordion-section-title hndle"><?php echo esc_html__('User fields', 'traveler') ?></h3>
                            ...
                            case 'advance':
                                ...
                                <li class="control-section accordion-section add-form-fields">
                                    ...
                                    <h3 class="accordion-section-title hndle"><?php echo esc_html__('Advance fields', 'traveler') ?></h3>
