...
if(!class_exists('WB_Form_Builder_PostCount_Zip')){

    class WB_Form_Builder_PostCount_Zip extends WB_Form_Builder_Abstract_fields{
        ...
        protected $field_id = 'postcode_zip';
...

        {
            ...
            $this->field_info = array(
                ...
                'desc' => esc_html__('Postcode/Zip field','traveler')
...

        {
            ...
            if(is_user_logged_in()){
                ...
                $value = get_user_meta($user_id,'st_zip_code', true);
    ...
    WB_Form_Builder_PostCount_Zip::inst();
