...
if(!class_exists('WB_Form_Builder_Telephone')){

    class WB_Form_Builder_Telephone extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'title' => esc_html__('Telephone','traveler'),

                'desc' => esc_html__('Telephone field','traveler')
...

        {
            ...
            if(is_user_logged_in()){
                ...
                $value = get_user_meta($user_id,'st_phone', true);
    ...
    WB_Form_Builder_Telephone::inst();
