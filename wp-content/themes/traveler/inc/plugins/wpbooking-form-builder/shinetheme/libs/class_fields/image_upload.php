    ...
    class WB_Form_Builder_Image_Upload extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'title' => esc_html__('Media Upload','traveler'),

                'desc' => esc_html__('Media upload field','traveler')
...

        {
            ...
            $html = '<div class="form-group '.$data['class'].' wb-upload-fields">
                        ...
                        <a class="wb-btn wb-btn-default wb-btn-sm wb-upload-image" href="#">'.esc_html__('Upload','traveler').'</a>
