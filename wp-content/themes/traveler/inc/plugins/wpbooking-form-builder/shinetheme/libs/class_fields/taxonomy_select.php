    ...
    class WB_Form_Builder_Taxonomy_Select extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_settings = array(
                ...
                array(
                    ...
                    'label' => esc_html__('Taxonomy','traveler'),
...

        {
            ...
            $this->field_info = array(
                ...
                'title' => esc_html__('Taxonomy Select','traveler'),

                'desc' => esc_html__('Taxonomy select field','traveler')
...

        {
            ...
            if(!empty($data['taxonomy'])){
                ...
                if(!empty($terms) && is_array($terms) && count($terms) > 0){
                    ...
                    $html .= '<option value="">'.esc_html__('--Choose one--','traveler').'</option>';
            ...
            $html = '<div class="form-row">
                    ...
                    if(!empty($data['taxonomy'])){
                        ...
                        if(!empty($terms) && is_array($terms) && count($terms) > 0){
                            ...
                            $html .= '<option '.selected( $value, '', false ).' value="">'.esc_html__('--Choose one--','traveler').'</option>';
