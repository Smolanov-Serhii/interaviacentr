...
if(!class_exists('WB_Form_Builder_First_Name')){

    class WB_Form_Builder_First_Name extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'desc' => esc_html__('First name field','traveler')
    ...
    WB_Form_Builder_First_Name::inst();
