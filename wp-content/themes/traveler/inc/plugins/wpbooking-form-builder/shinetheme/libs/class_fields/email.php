...
if(!class_exists('WB_Form_Builder_Email')){

    class WB_Form_Builder_Email extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'desc' => esc_html__('Email field','traveler')
...

        {
            ...
            $html = '<div class="form-group '.$data['class'].'">
                        ...
                        <input type="email" class="form-control" id="'.$data['custom_id'].'" name="'.$data['name'].'" placeholder="'.($data['placeholder']?$data['placeholder']:'').'" />
        ...
        function get_admin_html($data, $order_id){
            ...
            $html = '<div class="form-row">
                        ...
                        <div class="controls">
                            ...
                            <input type="email" name="'.$data['name'].'" value="'.$value.'"
