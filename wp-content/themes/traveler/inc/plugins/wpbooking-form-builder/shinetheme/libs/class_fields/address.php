...
if(!class_exists('WB_Form_Builder_Address')){

    class WB_Form_Builder_Address extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'desc' => esc_html__('Address field', 'traveler')
...

        {
            ...
            if(is_user_logged_in()){
                ...
                $value = get_user_meta($user_id,'st_address', true);
