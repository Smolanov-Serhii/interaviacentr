...
if(!class_exists('WB_Form_Builder_Number')){

    class WB_Form_Builder_Number extends WB_Form_Builder_Abstract_fields{
...

        {
            ...
            $this->field_info = array(
                ...
                'title' => esc_html__('Number','traveler'),

                'desc' => esc_html__('Number field','traveler')
...

        {
            ...
            $html = '<div class="form-group '.$data['class'].'">
                        ...
                        <input type="number" class="form-control" id="'.$data['custom_id'].'" name="'.$data['name'].'" placeholder="'.($data['placeholder']?$data['placeholder']:'').'" />
        ...
        function get_admin_html($data, $order_id){
            ...
            $html = '<div class="form-row">
                        ...
                        <div class="controls">
                            ...
                            <input type="number" name="'.$data['name'].'" value="'.$value.'" id="'.$data['custom_id'].'" 
