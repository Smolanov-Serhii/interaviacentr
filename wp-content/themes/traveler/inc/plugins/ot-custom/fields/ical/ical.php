...

            {
                ...
                if ( !empty( $post_id ) ):
                    ...
                    <button class="button button-primary button-large"
                            ...
                            id="save_ical"><?php echo __( 'Import', 'traveler' ); ?></button>
                    ...
                    <div class="format-setting">
                        ...
                        <div
                            ...
                            class="description"><?php echo __( 'This field will be shown when saved this post', 'traveler' ); ?></div>
