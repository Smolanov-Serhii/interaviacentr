            ...
            <div class="item">
                ...
                <div class="data">
                    ...
                    <div class="form">
                        ...
                        <label ><?php _e("Price:",'traveler') ?> </label>

                        <input name="st_price[]" value="<?php echo esc_html($v->price) ?>" type="text">

                        <label ><?php _e("Priority:",'traveler') ?> </label>
                    ...
                    <div class="form">
                        ...
                        <label ><?php _e("Start Date:",'traveler') ?> </label>
                        ...
                        <label ><?php _e("End Date:",'traveler') ?></label>
                ...
                <div class="control">
                    ...
                    <button class="button button-danger btn_del_price" type="button" ><?php _e("Delete",'traveler') ?></button>
...
<div class="nav" style="text-align: right">
    ...
    <button class="option-tree-list-item-add option-tree-ui-button button button-primary btn btn-primary btn_add_price" type="button" ><?php _e("Add Price",'traveler') ?></button>
...
<div class="data_price_html">
    ...
    <div class="item">
        ...
        <div class="control">
            ...
            <button class="option-tree-list-item-add option-tree-ui-button button button-default btn btn-danger btn_del_price" type="button" ><?php _e("Delete",'traveler') ?></button>
