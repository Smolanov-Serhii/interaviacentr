...
function bfi_wp_image_editor_check_notice() {
    printf("<div class='error'><p>%s</div>",
        __("The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.", 'traveler'));
}
}
...
class BFI_Image_Editor_GD_1_3 extends WP_Image_Editor_GD {
    ...
    public function rotate( $angle ) {
        ...
        return new WP_Error( 'image_rotate_error', __('Image rotate failed.', 'traveler'), $this->file );
    }
    ...
    public function opacity($opacity) {
        ...
        return new WP_Error( 'image_opacity_error', __('Image opacity change failed.', 'traveler'), $this->file );
    }
    ...
    public function colorize($hexColor) {
        ...
        return new WP_Error( 'image_colorize_error', __('Image color change failed.', 'traveler'), $this->file );
    }
    ...
    public function grayscale() {
        ...
        return new WP_Error( 'image_grayscale_error', __('Image grayscale failed.', 'traveler'), $this->file );
    }
    ...
    public function negate() {
        ...
        return new WP_Error( 'image_negate_error', __('Image negate failed.', 'traveler'), $this->file );
    }
}
}
