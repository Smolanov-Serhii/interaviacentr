                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <strong><?php echo esc_attr($adult_number); ?></strong>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <strong><?php echo esc_attr($child_number); ?></strong>
                                ...
                                <div class="form-row">
                                    ...
                                    <label class="form-label" for="check_out"><?php _e( 'Check out', 'traveler' ) ?>
                                                ...
                                                <?php foreach ( $extra_price as $key => $val ): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="80%">
                                                            ...
                                                            <label for="<?php echo esc_html($val[ 'extra_name' ]); ?>"

                                                                   class="ml20">

                                                                <strong><?php echo esc_html($val[ 'title' ]); ?></strong>
                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="" name="status">
                                            ...
                                            <option
                                                ...
                                                value="incomplete" <?php selected( $status, 'incomplete' ) ?> ><?php _e( 'Incomplete', 'traveler' ) ?></option>
