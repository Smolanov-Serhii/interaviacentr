...
$data=STAdmin::get_history_bookings('hotel_room',$offset,$limit);
...
$paging['base']=admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking%_%');
...
echo '<h2>'.__('Room Bookings','traveler').'</h2>';
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking')?>" method="get">
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking')?>" method="post">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="manage-column" width="10%">
                    ...
                    <a href="#"><span><?php _e('Check In','traveler')?></span><span class="sorting-indicator"></span></a>

                </th>

                <th class="manage-column" width="10%">

                    <a href="#"><span><?php _e('Check Out','traveler')?></span><span class="sorting-indicator"></span></a>

                </th>

                <th class="manage-column">

                    <a href="#"><span><?php _e('Hotel - Room Name','traveler')?></span><span class="sorting-indicator"></span></a>

                </th>

                <th class="manage-column " width="7%">

                    <a href="#"><span><?php _e('Room(s)','traveler')?></span><span class="sorting-indicator"></span></a>
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                ...
                                <strong><a class="row-title"
                                           ...
                                           href="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"
                                ...
                                <div class="row-actions">
                                    ...
                                    <a href="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit','traveler')?></a> |

                                    <a href="<?php echo admin_url('edit.php?post_type=hotel_room&page=st_hotel_room_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email','traveler')?></a>
