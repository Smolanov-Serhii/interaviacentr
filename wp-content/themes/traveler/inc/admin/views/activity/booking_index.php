<?php
    ...
    echo '<h2>' . __( 'Activity Booking', 'traveler' ) . '</h2>';
...
<form id="posts-filter" action="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking' ) ?>"

      method="get">

    <input type="hidden" name="post_type" value="st_activity">

    <input type="hidden" name="page" value="st_activity_booking">
    ...
    <table class="wp-list-table widefat fixed posts">
        ...
        <tr>
            ...
            <th class="manage-column" width="10%">
                ...
                <a href="#"><span><?php _e( 'Check Out', 'traveler' ) ?></span><span
            ...
            <th class="manage-column">
                ...
                <a href="#"><span><?php _e( 'Activity Name', 'traveler' ) ?></span><span
                    ...
                    <tr class="<?php if ( $i % 2 == 0 ) echo 'alternate'; ?>">
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <strong><a class="row-title"
                                       ...
                                       href="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking&section=edit_order_item&order_item_id=' . $post_id ); ?>"
                            ...
                            <div class="row-actions">
                                ...
                                <a href="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking&section=edit_order_item&order_item_id=' . $post_id ); ?>"><?php _e( 'Edit', 'traveler' ) ?></a>

                                |

                                <a href="<?php echo admin_url( 'edit.php?post_type=st_activity&page=st_activity_booking&section=resend_email_activity&order_item_id=' . $post_id ); ?>"><?php _e( 'Resend Email', 'traveler' ) ?></a>
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <?php $date = get_post_meta( $post_id, 'check_in', true );
                        ...
                        <td class="post-title page-title column-title">
                            ...
                            <?php $date = get_post_meta( $post_id, 'check_out', true );
