        ...
        <ul class="st_report_date_ranges">
            ...
            <li class="custom <?php if($current_range=='custom') echo 'active'; ?>">
                ...
                <form action="" method="get">
                    ...
                    <button type="submit" class="button" value="Go"><?php esc_html_e('Filter','traveler') ?></button>
...
<!--                        <select name="partner_id" class="select2-field" data-params="{type:partner}"></select>-->
                        ...
                        <label class="filter-label"><?php esc_html_e('Filter by Partner','traveler') ?></label>
...
//                        ?>
                        ...
                        <input name="partner_search" value="<?php echo esc_attr(STInput::get('partner_search')) ?>" data-placeholder="<?php esc_html_e('Filter by Partner','traveler') ?>" class="filter-control" type="text" data-params='{"type":"partner"}' />
...
<!--                        </select>-->
                    ...
                    <div class="filter-item">
                        ...
                        <button class="button" type="submit" value="filter" ><?php esc_html_e('Filter','traveler') ?></button>
                    ...
                    <table class="wp-list-table widefat striped pages">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="col-name"><?php esc_html_e('Partner Info','traveler') ?></th>

                                <th class="col-name"><?php esc_html_e('Total Items','traveler') ?></th>

                                <th class="col-name"><?php esc_html_e('Total Amount','traveler') ?></th>
                        ...
                        <tbody>
                            ...
                            <?php
...

                                {
...

                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo esc_html($oneUser['display_name'] )?><br>

                                                <?php echo esc_html($oneUser['user_email'] )?>
                                    ...
                                    printf('<tr><td colspan="3">%s</td></tr>',esc_html__('--- Empty ---','traveler'));
