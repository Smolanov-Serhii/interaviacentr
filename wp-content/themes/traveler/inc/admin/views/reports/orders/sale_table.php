                ...
                <div class="table-responsive">
                    ...
                    <table class="wp-list-table widefat striped pages">
                        ...
                        if (!empty($listsUsers)) {
                            ...
                            foreach ($listsUsers as $oneUser) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        #<?php echo esc_url($oneUser['order_item_id']) ?>
                                    ...
                                    <td><a href="<?php echo esc_url(get_permalink($oneUser['st_booking_id'])) ?>"

                                           target="_blank"><?php echo get_the_title($oneUser['st_booking_id']) ?></a>
                                    ...
                                    <td>
                                        ...
                                        <?php echo esc_html($oneUser['status'] )?>
                            ...
                            printf('<tr><td colspan="4">%s</td></tr>', esc_html__('--- Empty ---', 'traveler'));
