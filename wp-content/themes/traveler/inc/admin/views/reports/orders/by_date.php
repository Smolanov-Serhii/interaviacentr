...
switch ($current_range){
    case "year":
        ...
        $datasets=[
            'label'=>esc_html__('Total Money','traveler'),
...
<!--                        <select name="partner_id" class="select2-field" data-params="{type:partner}"></select>-->
                        ...
                        ?>
                        <input name="partner_id" value="<?php echo esc_attr(STInput::get('partner_id')) ?>" data-init='<?php echo json_encode($init) ?>' data-placeholder="<?php esc_html_e('Filter by Partner','traveler') ?>" class="select2-field" type="hidden" data-params='{"type":"partner"}' />
                    </div>
                    <div class="filter-item">
