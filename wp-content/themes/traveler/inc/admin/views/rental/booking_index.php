...
echo '<h2>'.__('Rental Booking','traveler').'</h2>';
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking')?>" method="get">
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking')?>" method="post">
        ...
        <thead>
            ...
            <tr>
                ...
                <th class="manage-column">
                    ...
                    <a href="#"><span><?php _e('Rental Name','traveler')?></span><span class="sorting-indicator"></span></a>
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                ...
                                <strong><a class="row-title"
                                           ...
                                           href="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"
                                ...
                                <div class="row-actions">
                                    ...
                                    <a href="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit','traveler')?></a> |

                                    <a href="<?php echo admin_url('edit.php?post_type=st_rental&page=st_rental_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email','traveler')?></a>
