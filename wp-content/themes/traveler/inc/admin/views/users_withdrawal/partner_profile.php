...
echo '<h2>'.__('Partner Profile','traveler').'</h2>';
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="st_withdrawal_info_name">
                ...
                <h4><strong><?php _e("User Name",'traveler') ?></strong>: <?php echo esc_html($data_user->user_nicename) ?>  </h4>

                <h4><strong><?php _e("Email",'traveler') ?></strong>: <?php echo esc_html($data_user->user_email) ?> </h4>

                <?php if($st_phone = get_user_meta($user_id , 'st_phone' , true)){ ?>

                    <h4><strong><?php _e("Phone",'traveler') ?></strong>: <?php echo esc_html($st_phone) ?> </h4>

                <?php } ?>

                <?php if( $website = get_the_author_meta('user_url',$user_id)){ ?>

                    <h4><strong><?php _e("Website",'traveler') ?></strong>: <?php echo esc_html($website) ?> </h4>
        ...
        <div class="col-md-4">
            ...
            <h4><strong><?php _e("Joined",'traveler') ?></strong>: <?php echo esc_html(date_i18n(TravelHelper::getDateFormat(),strtotime($data_user->user_registered))) ?>

            <h4><strong><?php _e("Total Earning",'traveler') ?></strong>: <?php echo esc_html(TravelHelper::format_money($total_earning['total']))  ?>

            <h4><strong><?php _e("Total Profit",'traveler') ?></strong>: <?php echo esc_html(TravelHelper::format_money($total_earning['average_total']))  ?>

            <h4><strong><?php _e("Total Balance",'traveler') ?></strong>: <?php echo esc_html(TravelHelper::format_money($your_balance))  ?>

            <h4><strong><?php _e("Total Payout",'traveler') ?></strong>: <?php echo esc_html(TravelHelper::format_money($total_price_payout))  ?>
...
<div class="container-fluid content-admin">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h2><?php _e("Withdrawal History",'traveler') ?></h2>
        ...
        <div class="col-md-12">
            ...
            <ul class="subsubsub">
                ...
                <li><a class="<?php if($st_tab=="all") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=".$name_page."&st_tab=all&st_action=partner_profile&st_user_id={$user_id}"); ?>"><?php _e("All",'traveler') ?></a> |</li>

                <li><a class="<?php if($st_tab=="partner_request") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=".$name_page."&st_tab=partner_request&st_action=partner_profile&st_user_id={$user_id}"); ?>"><?php _e("Request",'traveler') ?></a> |</li>

                <li><a class="<?php if($st_tab=="partner_completed") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=".$name_page."&st_tab=partner_completed&st_action=partner_profile&st_user_id={$user_id}"); ?>"><?php _e("Completed",'traveler') ?></a> |</li>

                <li><a class="<?php if($st_tab=="partner_cancel") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=".$name_page."&st_tab=partner_cancel&st_action=partner_profile&st_user_id={$user_id}"); ?>"><?php _e("Cancel",'traveler') ?></a></li>
            ...
            <div class="tablenav top">
                ...
                <div class="alignleft actions bulkactions">
                    ...
                    <form id="posts-filter" action="<?php echo admin_url('admin.php?page='.$name_page.'&st_tab='.$st_tab.'&st_action=partner_profile&st_user_id='.$user_id)?>" method="get">
                        ...
                        <input type="text" class="st_datepicker_withdrawal" format="yyyy-mm-dd"  name="st_date_start" placeholder="<?php _e('Filter by Date from','traveler')  ?>" value="<?php echo STInput::get('st_date_start') ?>"/>

                        <input type="text" class="st_datepicker_withdrawal" format="yyyy-mm-dd" name="st_date_end" placeholder="<?php _e('Filter by Date to','traveler')  ?>" value="<?php echo STInput::get('st_date_end') ?>"/>
                ...
                <table class="wp-list-table widefat fixed striped users">
                    ...
                    <tr>
                        ...
                        <th class="manage-column column-username column-primary  desc" id="username" scope="col">
                            ...
                            <span><?php _e("Created",'traveler') ?></span>

                        </th>

                        <th class="manage-column column-certificates"  scope="col">

                            <?php _e("Amount",'traveler') ?>

                        </th>

                        <th class="manage-column column-certificates" scope="col">

                            <?php _e("Payment",'traveler') ?>

                        </th>

                        <th class="manage-column column-certificates" scope="col">

                            <?php _e("Payment Info",'traveler') ?>

                        </th>

                        <th class="manage-column column-certificates" scope="col">

                            <?php _e("Status",'traveler') ?>
                                ...
                                <td data-colname="" class="role">
                                    ...
                                    <div class="row-actions">
                                        ...
                                        <span class="edit">
                                            ...
                                            <a href="javascript:void(0)" class="btn_change_withdrawal_partner_admin"><?php _e("Edit",'traveler') ?></a>
                                    ...
                                    <div class="hide content-change content-admin content-<?php  echo esc_attr($user_id) ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <strong><?php _e("Status",'traveler') ?>:</strong>

                                                <select class="st_status">

                                                    <option value="completed"><?php _e("Completed",'traveler') ?></option>

                                                    <option value="cancel"><?php _e("Cancel",'traveler') ?></option>
                                            ...
                                            <div class="col-md-12 content-message" >
                                                ...
                                                <strong><?php _e("Reasons for cancellation",'traveler') ?>:</strong>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <button type="button" class="btn_apply_withdrawal_partner_admin button" data-user-id="<?php  echo esc_attr($user_id) ?>" data-withdrawal-id="<?php  echo esc_attr($value->withdrawal_id) ?>"><?php _e("Apply",'traveler') ?></button>

                                                <button type="button" class="btn_cancel_withdrawal_partner_admin button" ><?php _e("Cancel",'traveler') ?></button>
    ...
    <div class="container-fluid content-admin" id="content-detail-service">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h2><?php _e("Detail Service",'traveler') ?></h2>
                ...
                <h2 class="nav-tab-wrapper">
                    ...
                    foreach($post_type as $k=>$v){
                        ...
                        if (STUser_f::_check_service_available_partner($v,$user_id)){
                            ...
                            <span data-post-type="<?php echo esc_html($v) ?>" class=" st_nav_service_partner nav-tab st-nav-<?php echo esc_html($v) ?> <?php if($k == 0) echo "nav-tab-active"; ?>"><?php echo esc_html( $obj->labels->singular_name); ?> (<?php echo STAdminWithdrawal::_count_item_post_type_by_user($v,$user_id); ?>)</span>
                            ...
                            <table class="wp-list-table widefat fixed striped">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" id="username" class="manage-column column-username column-primary  desc" style="width: 10%;">
                                        ...
                                        <span><?php _e("Image",'traveler') ?></span>

                                    </th>

                                    <th scope="col" id="username" class="manage-column column-username column-primary  desc">

                                        <span><?php _e("Title Service",'traveler') ?></span>

                                    </th>

                                    <th scope="col" class="manage-column">

                                        <?php _e("Price from",'traveler') ?>

                                    </th>

                                    <th scope="col" class="manage-column" width='30%'>

                                        <?php _e("Address",'traveler') ?>

                                    </th>

                                    <th scope="col" class="manage-column">

                                        <?php _e("Date Create",'traveler') ?>
