...
echo '<h2>'.__('Hotel Bookings','traveler').'</h2>';
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                ...
                                <div class="row-actions">
                                    ...
                                    <a href="<?php echo admin_url('edit.php?post_type=st_hotel&page=st_hotel_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit','traveler')?></a> |

                                    <a href="<?php echo admin_url('edit.php?post_type=st_hotel&page=st_hotel_booking&section=resend_email&order_item_id=' . $post_id); ?>"><?php _e('Resend Email','traveler')?></a>
