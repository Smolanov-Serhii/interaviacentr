...
echo '<h2>'.__('Partner Statistic','traveler').'</h2>';
        ...
        <div class="col-md-3">
            ...
            <div class="st-dashboard-stat st-month-madison st-dashboard-new st-month-2">
                ...
                <div class="title">
                    ...
                    <?php _e("Payout this Month",'traveler') ?>
            ...
            <?php } ?>
                ...
                <div class="st-dashboard-stat st-month-madison st-dashboard-new st-month-3">
                    ...
                    <div class="title">
                        ...
                        <?php _e("Pending Partner",'traveler') ?>
        ...
        <div class="col-md-3">
            ...
            <div class="st-dashboard-stat st-month-madison st-dashboard-new st-month-4">
                ...
                <div class="title">
                    ...
                    <?php _e("New Partner / Month",'traveler') ?>
                        ...
                        <div class="head_control">
                            ...
                            <div class="head_time bc_single">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5"><?php _e("Statistical graphs register",'traveler') ?></div>
                                    ...
                                    <form method="get" action="<?php echo admin_url("admin.php?page=st-users-partner-static-menu") ?>">
                                        ...
                                        <div class="col-md-7" style="text-align: right">
                                            ...
                                            <?php $st_year = STInput::request('st_year', date('Y')) ?>
                                                ...
                                                <?php _e("Select Year",'traveler') ?>:

                                                <select name="st_year" style="margin-right: 20px;">

                                                    <option <?php if($st_year == "all") echo "selected"; ?>  value="all"><?php _e("All",'traveler') ?></option>
                                                ...
                                                <?php  if($st_year != "all"){ ?>
                                                    ...
                                                    <?php _e("Month",'traveler') ?>:

                                                    <?php $st_month = STInput::request('st_month', date('m')) ?>

                                                    <select name="st_month">

                                                        <option <?php if($st_month == "all") echo "selected"; ?>  value="all"><?php _e("All",'traveler') ?></option>

                                                        <option <?php if($st_month == "01") echo "selected"; ?>  value="01"><?php _e("January",'traveler') ?></option>

                                                        <option <?php if($st_month == "02") echo "selected"; ?> value="02"><?php _e("February",'traveler') ?></option>

                                                        <option <?php if($st_month == "03") echo "selected"; ?> value="03"><?php _e("March",'traveler') ?></option>

                                                        <option <?php if($st_month == "04") echo "selected"; ?> value="04"><?php _e("April",'traveler') ?></option>

                                                        <option <?php if($st_month == "05") echo "selected"; ?> value="05"><?php _e("May",'traveler') ?></option>

                                                        <option <?php if($st_month == "06") echo "selected"; ?> value="06"><?php _e("June",'traveler') ?></option>

                                                        <option <?php if($st_month == "07") echo "selected"; ?> value="07"><?php _e("July",'traveler') ?></option>

                                                        <option <?php if($st_month == "08") echo "selected"; ?> value="08"><?php _e("August",'traveler') ?></option>

                                                        <option <?php if($st_month == "09") echo "selected"; ?> value="09"><?php _e("September",'traveler') ?></option>

                                                        <option <?php if($st_month == "10") echo "selected"; ?> value="10"><?php _e("October",'traveler') ?></option>

                                                        <option <?php if($st_month == "11") echo "selected"; ?> value="11"><?php _e("November",'traveler') ?></option>

                                                        <option <?php if($st_month == "12") echo "selected"; ?> value="12"><?php _e("December",'traveler') ?></option>
        ...
        <div class="col-md-3">
            ...
            <div class="st_bortlet box st_hotel st_bortlet_new_admin">
                ...
                <div class="st_bortlet-title">
                    ...
                    <div class="caption"><?php _e("Detailed statistics",'traveler') ?></div>

                </div>

                <div class="st_bortlet-body">

                    <strong><?php _e("Total Partner",'traveler') ?></strong>: <?php echo esc_html($data['total']) ?>
                    ...
                    <div class="table-scrollable">
                        ...
                        <table class="table table-bordered table-hover st_table_partner">
                            ...
                            <thead>
                                ...
                                <tr class="text-center">
                                    ...
                                    <th width="50%"><?php _e("Number Partner",'traveler') ?></th>
                        ...
                        if($check == false){
                            ...
                            echo "<h3 class='text-center'>".__("No Data",'traveler')."</h3>";
