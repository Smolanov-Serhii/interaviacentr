...
echo '<h2>'.__('Top Partner','traveler').'</h2>';
    ...
    <table class="wp-list-table widefat fixed striped users">
        ...
        <tr>
            ...
            <th class="manage-column column-email  desc" id="email" scope="col">
                ...
                <span><?php _e("Amount",'traveler') ?></span>

            </th>

            <th class="manage-column column-email  desc" id="email" scope="col">

                <span><?php _e("Service",'traveler') ?></span>
                    ...
                    <td class="username column-username has-row-actions column-primary">
                        ...
                        <?php if($st_tab != "partner"){ ?>
                            ...
                            <span class="edit">
                                ...
                                <a href="<?php echo admin_url("admin.php?page=st-users-top-partner-menu&st_action=approve_role&user_id=".$user_id."&st_tab=".$st_tab); ?>" class="button"><?php _e("Approved",'traveler') ?></a>

                                <a href="<?php echo admin_url("admin.php?page=st-users-top-partner-menu&st_action=cancel_role&user_id=".$user_id."&st_tab=".$st_tab); ?>" class="button"><?php _e("Cancel",'traveler') ?></a>
                        ...
                        foreach($post_type as $k=>$v){
                            ...
                            if (STUser_f::_check_service_available_partner($v,$user_id)){
                                ...
                                <div class="col-md-6">
                                    ...
                                    <strong><?php echo esc_attr($obj->labels->singular_name); ?></strong>:
