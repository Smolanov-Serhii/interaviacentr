...
<table id="partner_service" class="form-table <?php if($roles == 'partner') echo "show" ; else echo "hide"?>">
    ...
    <tbody>
        ...
        <tr>
            ...
            <th><label for="certificates"><?php _e("Partner Service",'traveler') ?></label></th>
