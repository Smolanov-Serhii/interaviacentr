<form id="posts-filter" class="partner-expire-countdown-form"
    ...
    <input type="submit" name="st_sendmail_expire_partner" class="button st_sendmail_expire_partner"
           ...
           id="st_sendmail_expire_partner" value="<?php echo __('Email to Partner', 'traveler'); ?>"/>
    ...
    <table class="wp-list-table widefat fixed striped users">
        ...
        <tr>
            ...
            <th class="manage-column column-date column-partner-countdown" id="date" scope="col">
                ...
                <b><?php _e("Number of day", 'traveler') ?></b>
                ...
                <tr id="user-<?php echo esc_attr($user_id) ?>">
                    ...
                    if ($order) {
                        ...
                        if ($time == 'unlimited') {
                            ...
                            $countdown_string = '<span class="partner-expire-countdown">' . esc_html__('Unlimited', 'traveler') . '</span>';
                            ...
                            $countdown_string = '<span class="partner-expire-countdown">' . $date_diff . '</span> ' . esc_html('day(s)', 'traveler');
                    ...
                    <td data-colname="date" class="role column-date column-countdown <?php echo esc_attr($class_notice); ?>">

                        <?php echo balanceTags($countdown_string); ?>
