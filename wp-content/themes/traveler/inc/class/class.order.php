    ...
    if ( !class_exists( 'STOrder' ) ) {
        class STOrder extends TravelerObject
        {
            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    'id'       => 'order_metabox',
                    'title'    => __( 'Order Setting', 'traveler' ),
                    'desc'     => '',
                    'pages'    => [ 'st_order' ],
                    'context'  => 'normal',
                    'priority' => 'high',
                    'fields'   => [
                        ...
                        [
                            'label' => __( 'Customer', 'traveler' ),
                            'id'    => 'id_user',
                            'type'  => 'user_select_ajax',
                        ],
                        [
                            'label' => __( 'Request Booking', 'traveler' ),
                            'id'    => 'st_o_note',
                            'type'  => 'textarea_simple'
                        ],
                        [
                            'label'   => __( 'Payment Method', 'traveler' ),
                            'id'      => 'payment_method',
                            'type'    => 'select',
                            'choices' => [
                                [
                                    'label' => __( 'Paypal', 'traveler' ),
                                    'value' => 'paypal',

                                ],
                                [
                                    'label' => __( 'Submit Form', 'traveler' ),
                                    'value' => 'submit_form',
