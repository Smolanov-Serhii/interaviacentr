(function ($) {
    ...
    $(document).on('click', '.checkbox-filter-ajax, a.pagination', function (e) {
        ...
        if ($('#ajax-filter-content').length > 0) {
            ...
            var start = $('form[post_type="st_tours"] .irs-from').text();
            var end = $('form[post_type="st_tours"] .irs-to').text();
            ...
            if(!$('#jtour-orderby').length || checkOrderBy){
            ...
            data['page'] = pageNum;
            data['isajax'] = '1';
            data['jcategory'] = $('#jtour-category').val();
