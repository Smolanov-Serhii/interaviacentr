(function ($) {
    ...
    $(document).on('click', '.checkbox-filter-ajax, a.pagination', function (e) {
        if ($('#ajax-filter-content').length > 0) {
            ...
            var start = $('form[post_type="hotel_room"] .irs-from').text();
            var end = $('form[post_type="hotel_room"] .irs-to').text();
            ...
            var active_tax_faci_string = active_tax_faci.toString();
            var active_tax_type_string = active_tax_type.toString();
            ...
            if(!$('#jhotelroom-orderby').length || checkOrderBy){
            ...
            xhr = $.ajax({
                ...
                complete: function () {
                    ...
                    $('html, body').animate({
                          scrollTop: $("div.sort_top").offset().top
                    }, 400);
                },
            });
            requestRunning = true;
    ...
    $(document).ready(function(){
        $('.search_rating_star, .ajax-tax-name').on('click', function(){
