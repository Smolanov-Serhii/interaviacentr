jQuery(function ($) {
    ...
    var request;
    $('.ad-refund-list .with_a_refund').on('click', function (e) {
        e.preventDefault();
        var el = $(this);
    ...
    $('#with-refund-modal, #with-refund-modal .modal-header .close').on('click', function (e) {
        if (e.target === this) {
    ...
    $('#with-refund-modal .modal-header .close, #with-refund-modal .modal-footer .close-modal').on('click', function (e) {
        $('#with-refund-modal').fadeOut('', function () {
            if(request_running) {
                request.abort();
            }
