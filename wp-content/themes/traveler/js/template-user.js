...
jQuery(function (a) {
    ...
    "activity_price" == t ? (a(".activity_price").show(500), a(".people_price").hide(500)) : (a(".activity_price").hide(500)), a("#type_price").on('change', function () {
        var t = a(this).val();
    ...
    "specific_date" == e ? (a(".data_activity_specific_date").show(500), a(".data_duration").hide(500)) : (a(".data_activity_specific_date").hide(500), a(".data_duration").show(500)), a("#type_activity").on('change', function () {
        var t = a(this).val();
    ...
    var t = a("#type_price").val();
    "tour_price" == t ? (a(".tour_price").show(500), a(".people_price").hide(500)) : (a(".tour_price").hide(500)), a("#type_price").on('change', function () {
        var t = a(this).val();
    ...
    "specific_date" == e ? (a(".data_specific_date").show(500), a(".data_duration").hide(500)) : (a(".data_specific_date").hide(500), a(".data_duration").show(500)), a("#type_tour").on('change', function () {
        var t = a(this).val();
    ...
    var e = a("#tour_type").val();
    "specific_date" == e ? (a(".data_specific_date").show(500), a(".data_duration").hide(500)) : (a(".data_specific_date").hide(500), a(".data_duration").show(500)), a("#tour_type").on('change', function () {
        var t = a(this).val();
        "specific_date" == t ? (a(".data_specific_date").show(500), a(".data_duration").hide(500)) : (a(".data_specific_date").hide(500), a(".data_duration").show(500))
    })
}), jQuery(function (a) {
...
(function($){
    ...
    $('#btn_add_tours_faq', partnerPage).on('click', function () {
    ...
    $('#btn_add_activity_faq', partnerPage).on('click', function () {
