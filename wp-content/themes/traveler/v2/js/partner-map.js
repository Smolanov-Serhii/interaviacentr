...
jQuery(function($) {
    $('.st-field-map').each(function () {
        ...
        function geocodeLatLng(geocoder, map, infowindow) {
            var latlng = {
                lat: parseFloat(bt_ot_gmap_input_lat.val()),
                lng: parseFloat(bt_ot_gmap_input_lng.val())
            };
            geocoder.geocode({
                'location': latlng
        ...
        $('.bt_ot_gmap_search', $(this)).on('click', function () {
        ...
        let mapData = gmap_el.data('data_show');
